...
import com.konfigthis.client.model.PagedResultOfPayGroup;
...
public class LegalEntityPayGroupsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LegalEntityPayGroupsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LegalEntityPayGroupsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listByLegalEntityIdCall(Integer legalEntityId, String continuationToken, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/legalentities/{legalEntityId}/payGroups"
    ...
    private ApiResponse<PagedResultOfPayGroup> listByLegalEntityIdWithHttpInfo(Integer legalEntityId, String continuationToken) throws ApiException {
        okhttp3.Call localVarCall = listByLegalEntityIdValidateBeforeCall(legalEntityId, continuationToken, null);
        Type localVarReturnType = new TypeToken<PagedResultOfPayGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listByLegalEntityIdAsync(Integer legalEntityId, String continuationToken, final ApiCallback<PagedResultOfPayGroup> _callback) throws ApiException {
    ...
    public class ListByLegalEntityIdRequestBuilder {
         ...
         * @param continuationToken Token to get the next set of Legal Entity Pay Groups (optional)
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Returns a collection of the Pay Groups available for the Legal Entity ID provided. </td><td>  -  </td></tr>
         </table>
         */
         ...
         */
        public PagedResultOfPayGroup execute() throws ApiException {
            ApiResponse<PagedResultOfPayGroup> localVarResp = listByLegalEntityIdWithHttpInfo(legalEntityId, continuationToken);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listByLegalEntityId request with HTTP info returned
         * @return ApiResponse&lt;PagedResultOfPayGroup&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<PagedResultOfPayGroup> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PagedResultOfPayGroup> _callback) throws ApiException {
