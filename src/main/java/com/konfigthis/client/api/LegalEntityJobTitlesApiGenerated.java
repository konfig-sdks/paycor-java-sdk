...
public class LegalEntityJobTitlesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LegalEntityJobTitlesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LegalEntityJobTitlesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listByLegalEntityIdCall(Integer legalEntityId, String continuationToken, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/legalentities/{legalEntityId}/jobtitles"
    ...
    private ApiResponse<PagedResultOfTenantJobTitle> listByLegalEntityIdWithHttpInfo(Integer legalEntityId, String continuationToken) throws ApiException {
    ...
    private okhttp3.Call listByLegalEntityIdAsync(Integer legalEntityId, String continuationToken, final ApiCallback<PagedResultOfTenantJobTitle> _callback) throws ApiException {
    ...
    public class ListByLegalEntityIdRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Returns Job Titles based on the LegalEntityId provided. </td><td>  -  </td></tr>
         </table>
         */
        ...
        public PagedResultOfTenantJobTitle execute() throws ApiException {
            ApiResponse<PagedResultOfTenantJobTitle> localVarResp = listByLegalEntityIdWithHttpInfo(legalEntityId, continuationToken);
     ...
     * @param legalEntityId ID of the Legal Entity you want to get Job Titles. (required)
     * @return ListByLegalEntityIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
