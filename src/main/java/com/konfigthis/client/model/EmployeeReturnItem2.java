...
import com.konfigthis.client.model.WorkEmailExample2;
...
public class EmployeeReturnItem2 {
  ...
  private WorkEmailExample2 email;
  ...
  public EmployeeReturnItem2() {
  }

  public EmployeeReturnItem2 id(String id) {
  ...
  **/
  ...
  public EmployeeReturnItem2 employeeNumber(String employeeNumber) {
  ...
  **/
  ...
  public EmployeeReturnItem2 alternateEmployeeNumber(String alternateEmployeeNumber) {
  ...
  **/
  ...
  public EmployeeReturnItem2 badgeNumber(String badgeNumber) {
  ...
  **/
  ...
  public EmployeeReturnItem2 firstName(String firstName) {
  ...
  **/
  ...
  public EmployeeReturnItem2 middleName(String middleName) {
  ...
  **/
  ...
  public EmployeeReturnItem2 lastName(String lastName) {
  ...
  **/
  ...
  public EmployeeReturnItem2 email(WorkEmailExample2 email) {
  ...
  **/
  ...
  public WorkEmailExample2 getEmail() {
    return email;
  }


  public void setEmail(WorkEmailExample2 email) {
  ...
  public EmployeeReturnItem2 employmentDateData(EmploymentDateData employmentDateData) {
  ...
  **/
  ...
  public EmployeeReturnItem2 positionData(EmployeePositionData positionData) {
  ...
  **/
  ...
  public EmployeeReturnItem2 statusData(EmployeeStatusData statusData) {
  ...
  **/
  ...
  public EmployeeReturnItem2 workLocation(EmployeeWorkLocationData workLocation) {
  ...
  **/
  ...
  public EmployeeReturnItem2 earnings(ResourceReference earnings) {
  ...
  **/
  ...
  public EmployeeReturnItem2 deductions(ResourceReference deductions) {
  ...
  **/
  ...
  public EmployeeReturnItem2 taxes(ResourceReference taxes) {
  ...
  **/
  ...
  public EmployeeReturnItem2 directDeposits(ResourceReference directDeposits) {
  ...
  **/
  ...
  public EmployeeReturnItem2 payRates(ResourceReference payRates) {
  ...
  **/
  ...
  public EmployeeReturnItem2 legalEntity(ResourceReference legalEntity) {
  ...
  **/
  ...
  public EmployeeReturnItem2 person(ResourceReference person) {
  ...
  **/
  ...
  public EmployeeReturnItem2 department(ResourceReference department) {
  ...
  **/
   ...
   * @return the EmployeeReturnItem2 instance itself
   */
  public EmployeeReturnItem2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeReturnItem2 employeeReturnItem2 = (EmployeeReturnItem2) o;
    return Objects.equals(this.id, employeeReturnItem2.id) &&
        Objects.equals(this.employeeNumber, employeeReturnItem2.employeeNumber) &&
        Objects.equals(this.alternateEmployeeNumber, employeeReturnItem2.alternateEmployeeNumber) &&
        Objects.equals(this.badgeNumber, employeeReturnItem2.badgeNumber) &&
        Objects.equals(this.firstName, employeeReturnItem2.firstName) &&
        Objects.equals(this.middleName, employeeReturnItem2.middleName) &&
        Objects.equals(this.lastName, employeeReturnItem2.lastName) &&
        Objects.equals(this.email, employeeReturnItem2.email) &&
        Objects.equals(this.employmentDateData, employeeReturnItem2.employmentDateData) &&
        Objects.equals(this.positionData, employeeReturnItem2.positionData) &&
        Objects.equals(this.statusData, employeeReturnItem2.statusData) &&
        Objects.equals(this.workLocation, employeeReturnItem2.workLocation) &&
        Objects.equals(this.earnings, employeeReturnItem2.earnings) &&
        Objects.equals(this.deductions, employeeReturnItem2.deductions) &&
        Objects.equals(this.taxes, employeeReturnItem2.taxes) &&
        Objects.equals(this.directDeposits, employeeReturnItem2.directDeposits) &&
        Objects.equals(this.payRates, employeeReturnItem2.payRates) &&
        Objects.equals(this.legalEntity, employeeReturnItem2.legalEntity) &&
        Objects.equals(this.person, employeeReturnItem2.person) &&
        Objects.equals(this.department, employeeReturnItem2.department)&&
        Objects.equals(this.additionalProperties, employeeReturnItem2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeReturnItem2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeReturnItem2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeReturnItem2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeReturnItem2 is not found in the empty JSON string", EmployeeReturnItem2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Email") != null && !jsonObj.get("Email").isJsonNull()) {
        WorkEmailExample2.validateJsonObject(jsonObj.getAsJsonObject("Email"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeReturnItem2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeReturnItem2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeReturnItem2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeReturnItem2.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeReturnItem2>() {
           @Override
           public void write(JsonWriter out, EmployeeReturnItem2 value) throws IOException {
           ...
           @Override
           public EmployeeReturnItem2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeReturnItem2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeReturnItem2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeReturnItem2
  * @throws IOException if the JSON string is invalid with respect to EmployeeReturnItem2
  */
  public static EmployeeReturnItem2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeReturnItem2.class);
  }

 /**
  * Convert an instance of EmployeeReturnItem2 to an JSON string
  *
  * @return JSON string
  */
