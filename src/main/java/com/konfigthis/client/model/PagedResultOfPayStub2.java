...
import com.konfigthis.client.model.PayStub2;
...
public class PagedResultOfPayStub2 {
  ...
  private List<PayStub2> records = null;

  public PagedResultOfPayStub2() {
  }

  public PagedResultOfPayStub2 hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayStub2 continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayStub2 additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayStub2 records(List<PayStub2> records) {
  ...
  public PagedResultOfPayStub2 addRecordsItem(PayStub2 recordsItem) {
  ...
  **/
  ...
  public List<PayStub2> getRecords() {
    return records;
  }


  public void setRecords(List<PayStub2> records) {
   ...
   * @return the PagedResultOfPayStub2 instance itself
   */
  public PagedResultOfPayStub2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayStub2 pagedResultOfPayStub2 = (PagedResultOfPayStub2) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayStub2.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayStub2.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayStub2.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayStub2.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayStub2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayStub2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayStub2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayStub2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayStub2 is not found in the empty JSON string", PagedResultOfPayStub2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayStub2.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayStub2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayStub2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayStub2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayStub2.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayStub2>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayStub2 value) throws IOException {
           ...
           @Override
           public PagedResultOfPayStub2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayStub2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayStub2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayStub2
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayStub2
  */
  public static PagedResultOfPayStub2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayStub2.class);
  }

 /**
  * Convert an instance of PagedResultOfPayStub2 to an JSON string
  *
  * @return JSON string
  */
