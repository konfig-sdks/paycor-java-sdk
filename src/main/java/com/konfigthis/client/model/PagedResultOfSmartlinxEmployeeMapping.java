...
import com.konfigthis.client.model.SmartlinxEmployeeMapping;
...
public class PagedResultOfSmartlinxEmployeeMapping {
  ...
  private List<SmartlinxEmployeeMapping> records = null;

  public PagedResultOfSmartlinxEmployeeMapping() {
  }

  public PagedResultOfSmartlinxEmployeeMapping hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfSmartlinxEmployeeMapping continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfSmartlinxEmployeeMapping additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfSmartlinxEmployeeMapping records(List<SmartlinxEmployeeMapping> records) {
  ...
  public PagedResultOfSmartlinxEmployeeMapping addRecordsItem(SmartlinxEmployeeMapping recordsItem) {
  ...
  **/
  ...
  public List<SmartlinxEmployeeMapping> getRecords() {
    return records;
  }


  public void setRecords(List<SmartlinxEmployeeMapping> records) {
   ...
   * @return the PagedResultOfSmartlinxEmployeeMapping instance itself
   */
  public PagedResultOfSmartlinxEmployeeMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfSmartlinxEmployeeMapping pagedResultOfSmartlinxEmployeeMapping = (PagedResultOfSmartlinxEmployeeMapping) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfSmartlinxEmployeeMapping.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfSmartlinxEmployeeMapping.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfSmartlinxEmployeeMapping.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfSmartlinxEmployeeMapping.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfSmartlinxEmployeeMapping.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfSmartlinxEmployeeMapping {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfSmartlinxEmployeeMapping
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfSmartlinxEmployeeMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfSmartlinxEmployeeMapping is not found in the empty JSON string", PagedResultOfSmartlinxEmployeeMapping.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            SmartlinxEmployeeMapping.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfSmartlinxEmployeeMapping.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfSmartlinxEmployeeMapping' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfSmartlinxEmployeeMapping> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfSmartlinxEmployeeMapping.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfSmartlinxEmployeeMapping>() {
           @Override
           public void write(JsonWriter out, PagedResultOfSmartlinxEmployeeMapping value) throws IOException {
           ...
           @Override
           public PagedResultOfSmartlinxEmployeeMapping read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfSmartlinxEmployeeMapping instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfSmartlinxEmployeeMapping given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfSmartlinxEmployeeMapping
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfSmartlinxEmployeeMapping
  */
  public static PagedResultOfSmartlinxEmployeeMapping fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfSmartlinxEmployeeMapping.class);
  }

 /**
  * Convert an instance of PagedResultOfSmartlinxEmployeeMapping to an JSON string
  *
  * @return JSON string
  */
