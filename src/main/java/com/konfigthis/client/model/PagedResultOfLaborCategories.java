...
import com.konfigthis.client.model.LaborCategories;
...
public class PagedResultOfLaborCategories {
  ...
  private List<LaborCategories> records = null;

  public PagedResultOfLaborCategories() {
  }

  public PagedResultOfLaborCategories hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfLaborCategories continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfLaborCategories additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfLaborCategories records(List<LaborCategories> records) {
  ...
  public PagedResultOfLaborCategories addRecordsItem(LaborCategories recordsItem) {
  ...
  **/
  ...
  public List<LaborCategories> getRecords() {
    return records;
  }


  public void setRecords(List<LaborCategories> records) {
   ...
   * @return the PagedResultOfLaborCategories instance itself
   */
  public PagedResultOfLaborCategories putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfLaborCategories pagedResultOfLaborCategories = (PagedResultOfLaborCategories) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfLaborCategories.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfLaborCategories.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfLaborCategories.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfLaborCategories.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfLaborCategories.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfLaborCategories {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfLaborCategories
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfLaborCategories.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfLaborCategories is not found in the empty JSON string", PagedResultOfLaborCategories.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            LaborCategories.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfLaborCategories.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfLaborCategories' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfLaborCategories> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfLaborCategories.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfLaborCategories>() {
           @Override
           public void write(JsonWriter out, PagedResultOfLaborCategories value) throws IOException {
           ...
           @Override
           public PagedResultOfLaborCategories read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfLaborCategories instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfLaborCategories given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfLaborCategories
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfLaborCategories
  */
  public static PagedResultOfLaborCategories fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfLaborCategories.class);
  }

 /**
  * Convert an instance of PagedResultOfLaborCategories to an JSON string
  *
  * @return JSON string
  */
