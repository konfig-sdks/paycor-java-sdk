...
import com.konfigthis.client.model.PayStub;
...
public class PagedResultOfPayStub {
  ...
  private List<PayStub> records = null;

  public PagedResultOfPayStub() {
  }

  public PagedResultOfPayStub hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayStub continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayStub additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayStub records(List<PayStub> records) {
  ...
  public PagedResultOfPayStub addRecordsItem(PayStub recordsItem) {
  ...
  **/
  ...
  public List<PayStub> getRecords() {
    return records;
  }


  public void setRecords(List<PayStub> records) {
   ...
   * @return the PagedResultOfPayStub instance itself
   */
  public PagedResultOfPayStub putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayStub pagedResultOfPayStub = (PagedResultOfPayStub) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayStub.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayStub.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayStub.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayStub.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayStub.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayStub {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayStub
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayStub.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayStub is not found in the empty JSON string", PagedResultOfPayStub.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayStub.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayStub.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayStub' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayStub> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayStub.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayStub>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayStub value) throws IOException {
           ...
           @Override
           public PagedResultOfPayStub read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayStub instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayStub given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayStub
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayStub
  */
  public static PagedResultOfPayStub fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayStub.class);
  }

 /**
  * Convert an instance of PagedResultOfPayStub to an JSON string
  *
  * @return JSON string
  */
