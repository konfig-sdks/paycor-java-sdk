...
import com.konfigthis.client.model.TimeCardV3;
...
public class PagedResultOfTimeCardV3 {
  ...
  private List<TimeCardV3> records = null;

  public PagedResultOfTimeCardV3() {
  }

  public PagedResultOfTimeCardV3 hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTimeCardV3 continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTimeCardV3 additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTimeCardV3 records(List<TimeCardV3> records) {
  ...
  public PagedResultOfTimeCardV3 addRecordsItem(TimeCardV3 recordsItem) {
  ...
  **/
  ...
  public List<TimeCardV3> getRecords() {
    return records;
  }


  public void setRecords(List<TimeCardV3> records) {
   ...
   * @return the PagedResultOfTimeCardV3 instance itself
   */
  public PagedResultOfTimeCardV3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTimeCardV3 pagedResultOfTimeCardV3 = (PagedResultOfTimeCardV3) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTimeCardV3.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTimeCardV3.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTimeCardV3.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTimeCardV3.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTimeCardV3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTimeCardV3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTimeCardV3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTimeCardV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTimeCardV3 is not found in the empty JSON string", PagedResultOfTimeCardV3.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TimeCardV3.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTimeCardV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTimeCardV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTimeCardV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTimeCardV3.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTimeCardV3>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTimeCardV3 value) throws IOException {
           ...
           @Override
           public PagedResultOfTimeCardV3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTimeCardV3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTimeCardV3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTimeCardV3
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTimeCardV3
  */
  public static PagedResultOfTimeCardV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTimeCardV3.class);
  }

 /**
  * Convert an instance of PagedResultOfTimeCardV3 to an JSON string
  *
  * @return JSON string
  */
