...
import com.konfigthis.client.model.EmployeePayRate;
...
public class PagedResultOfEmployeePayRate {
  ...
  private List<EmployeePayRate> records = null;

  public PagedResultOfEmployeePayRate() {
  }

  public PagedResultOfEmployeePayRate hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayRate continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayRate additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayRate records(List<EmployeePayRate> records) {
  ...
  public PagedResultOfEmployeePayRate addRecordsItem(EmployeePayRate recordsItem) {
  ...
  **/
  ...
  public List<EmployeePayRate> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeePayRate> records) {
   ...
   * @return the PagedResultOfEmployeePayRate instance itself
   */
  public PagedResultOfEmployeePayRate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeePayRate pagedResultOfEmployeePayRate = (PagedResultOfEmployeePayRate) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeePayRate.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeePayRate.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeePayRate.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeePayRate.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeePayRate.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeePayRate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeePayRate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeePayRate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeePayRate is not found in the empty JSON string", PagedResultOfEmployeePayRate.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeePayRate.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeePayRate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeePayRate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeePayRate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeePayRate.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeePayRate>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeePayRate value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeePayRate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeePayRate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeePayRate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeePayRate
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeePayRate
  */
  public static PagedResultOfEmployeePayRate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeePayRate.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeePayRate to an JSON string
  *
  * @return JSON string
  */
