...
import com.konfigthis.client.model.ActivityType;
...
public class PagedResultOfActivityType {
  ...
  private List<ActivityType> records = null;

  public PagedResultOfActivityType() {
  }

  public PagedResultOfActivityType hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfActivityType continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfActivityType additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfActivityType records(List<ActivityType> records) {
  ...
  public PagedResultOfActivityType addRecordsItem(ActivityType recordsItem) {
  ...
  **/
  ...
  public List<ActivityType> getRecords() {
    return records;
  }


  public void setRecords(List<ActivityType> records) {
   ...
   * @return the PagedResultOfActivityType instance itself
   */
  public PagedResultOfActivityType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfActivityType pagedResultOfActivityType = (PagedResultOfActivityType) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfActivityType.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfActivityType.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfActivityType.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfActivityType.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfActivityType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfActivityType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfActivityType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfActivityType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfActivityType is not found in the empty JSON string", PagedResultOfActivityType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            ActivityType.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfActivityType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfActivityType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfActivityType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfActivityType.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfActivityType>() {
           @Override
           public void write(JsonWriter out, PagedResultOfActivityType value) throws IOException {
           ...
           @Override
           public PagedResultOfActivityType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfActivityType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfActivityType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfActivityType
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfActivityType
  */
  public static PagedResultOfActivityType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfActivityType.class);
  }

 /**
  * Convert an instance of PagedResultOfActivityType to an JSON string
  *
  * @return JSON string
  */
