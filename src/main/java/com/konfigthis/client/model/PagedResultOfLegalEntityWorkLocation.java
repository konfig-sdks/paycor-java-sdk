...
public class PagedResultOfLegalEntityWorkLocation {
  ...
  private List<LegalEntityWorkLocation> records = null;

  public PagedResultOfLegalEntityWorkLocation() {
  }

  public PagedResultOfLegalEntityWorkLocation hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityWorkLocation continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityWorkLocation additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityWorkLocation records(List<LegalEntityWorkLocation> records) {
  ...
  public PagedResultOfLegalEntityWorkLocation addRecordsItem(LegalEntityWorkLocation recordsItem) {
  ...
  **/
  ...
  public List<LegalEntityWorkLocation> getRecords() {
    return records;
  }


  public void setRecords(List<LegalEntityWorkLocation> records) {
   ...
   * @return the PagedResultOfLegalEntityWorkLocation instance itself
   */
  public PagedResultOfLegalEntityWorkLocation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfLegalEntityWorkLocation pagedResultOfLegalEntityWorkLocation = (PagedResultOfLegalEntityWorkLocation) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfLegalEntityWorkLocation.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfLegalEntityWorkLocation.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfLegalEntityWorkLocation.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfLegalEntityWorkLocation.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfLegalEntityWorkLocation.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfLegalEntityWorkLocation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfLegalEntityWorkLocation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfLegalEntityWorkLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfLegalEntityWorkLocation is not found in the empty JSON string", PagedResultOfLegalEntityWorkLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            LegalEntityWorkLocation.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfLegalEntityWorkLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfLegalEntityWorkLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfLegalEntityWorkLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfLegalEntityWorkLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfLegalEntityWorkLocation>() {
           @Override
           public void write(JsonWriter out, PagedResultOfLegalEntityWorkLocation value) throws IOException {
           ...
           @Override
           public PagedResultOfLegalEntityWorkLocation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfLegalEntityWorkLocation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfLegalEntityWorkLocation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfLegalEntityWorkLocation
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfLegalEntityWorkLocation
  */
  public static PagedResultOfLegalEntityWorkLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfLegalEntityWorkLocation.class);
  }

 /**
  * Convert an instance of PagedResultOfLegalEntityWorkLocation to an JSON string
  *
  * @return JSON string
  */
