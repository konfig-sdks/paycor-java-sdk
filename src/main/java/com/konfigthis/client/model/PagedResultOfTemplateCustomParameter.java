...
import com.konfigthis.client.model.TemplateCustomParameter;
...
public class PagedResultOfTemplateCustomParameter {
  ...
  private List<TemplateCustomParameter> records = null;

  public PagedResultOfTemplateCustomParameter() {
  }

  public PagedResultOfTemplateCustomParameter hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTemplateCustomParameter continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTemplateCustomParameter additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTemplateCustomParameter records(List<TemplateCustomParameter> records) {
  ...
  public PagedResultOfTemplateCustomParameter addRecordsItem(TemplateCustomParameter recordsItem) {
  ...
  **/
  ...
  public List<TemplateCustomParameter> getRecords() {
    return records;
  }


  public void setRecords(List<TemplateCustomParameter> records) {
   ...
   * @return the PagedResultOfTemplateCustomParameter instance itself
   */
  public PagedResultOfTemplateCustomParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTemplateCustomParameter pagedResultOfTemplateCustomParameter = (PagedResultOfTemplateCustomParameter) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTemplateCustomParameter.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTemplateCustomParameter.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTemplateCustomParameter.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTemplateCustomParameter.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTemplateCustomParameter.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTemplateCustomParameter {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTemplateCustomParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTemplateCustomParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTemplateCustomParameter is not found in the empty JSON string", PagedResultOfTemplateCustomParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TemplateCustomParameter.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTemplateCustomParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTemplateCustomParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTemplateCustomParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTemplateCustomParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTemplateCustomParameter>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTemplateCustomParameter value) throws IOException {
           ...
           @Override
           public PagedResultOfTemplateCustomParameter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTemplateCustomParameter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTemplateCustomParameter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTemplateCustomParameter
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTemplateCustomParameter
  */
  public static PagedResultOfTemplateCustomParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTemplateCustomParameter.class);
  }

 /**
  * Convert an instance of PagedResultOfTemplateCustomParameter to an JSON string
  *
  * @return JSON string
  */
