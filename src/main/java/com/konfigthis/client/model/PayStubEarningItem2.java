...
public class PayStubEarningItem2 {
  ...
  public PayStubEarningItem2() {
  }

  public PayStubEarningItem2 earningCode(String earningCode) {
  ...
  **/
  ...
  public PayStubEarningItem2 earningDescription(String earningDescription) {
  ...
  **/
  ...
  public PayStubEarningItem2 globalEarningCode(String globalEarningCode) {
  ...
  **/
  ...
  public PayStubEarningItem2 earningAmount(Double earningAmount) {
  ...
  public PayStubEarningItem2 earningAmount(Integer earningAmount) {
  ...
  **/
  ...
  public PayStubEarningItem2 earningHours(Double earningHours) {
  ...
  public PayStubEarningItem2 earningHours(Integer earningHours) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "160", value = "Hours covered by this earning")
  ...
  public PayStubEarningItem2 earningRate(Double earningRate) {
  ...
  public PayStubEarningItem2 earningRate(Integer earningRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "30", value = "Hourly rate paid by this earning")
  ...
  public PayStubEarningItem2 departmentCode(Long departmentCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "334", value = "Numeric code of department ")
   ...
   * @return the PayStubEarningItem2 instance itself
   */
  public PayStubEarningItem2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PayStubEarningItem2 payStubEarningItem2 = (PayStubEarningItem2) o;
    return Objects.equals(this.earningCode, payStubEarningItem2.earningCode) &&
        Objects.equals(this.earningDescription, payStubEarningItem2.earningDescription) &&
        Objects.equals(this.globalEarningCode, payStubEarningItem2.globalEarningCode) &&
        Objects.equals(this.earningAmount, payStubEarningItem2.earningAmount) &&
        Objects.equals(this.earningHours, payStubEarningItem2.earningHours) &&
        Objects.equals(this.earningRate, payStubEarningItem2.earningRate) &&
        Objects.equals(this.departmentCode, payStubEarningItem2.departmentCode)&&
        Objects.equals(this.additionalProperties, payStubEarningItem2.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(earningCode, earningDescription, globalEarningCode, earningAmount, earningHours, earningRate, departmentCode, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayStubEarningItem2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PayStubEarningItem2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PayStubEarningItem2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PayStubEarningItem2 is not found in the empty JSON string", PayStubEarningItem2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PayStubEarningItem2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PayStubEarningItem2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PayStubEarningItem2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PayStubEarningItem2.class));

       return (TypeAdapter<T>) new TypeAdapter<PayStubEarningItem2>() {
           @Override
           public void write(JsonWriter out, PayStubEarningItem2 value) throws IOException {
           ...
           @Override
           public PayStubEarningItem2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PayStubEarningItem2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PayStubEarningItem2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PayStubEarningItem2
  * @throws IOException if the JSON string is invalid with respect to PayStubEarningItem2
  */
  public static PayStubEarningItem2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PayStubEarningItem2.class);
  }

 /**
  * Convert an instance of PayStubEarningItem2 to an JSON string
  *
  * @return JSON string
  */
