...
import com.konfigthis.client.model.OnDemandPayDeductionInformation;
...
public class PagedResultOfOnDemandPayDeductionInformation {
  ...
  private List<OnDemandPayDeductionInformation> records = null;

  public PagedResultOfOnDemandPayDeductionInformation() {
  }

  public PagedResultOfOnDemandPayDeductionInformation hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfOnDemandPayDeductionInformation continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfOnDemandPayDeductionInformation additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfOnDemandPayDeductionInformation records(List<OnDemandPayDeductionInformation> records) {
  ...
  public PagedResultOfOnDemandPayDeductionInformation addRecordsItem(OnDemandPayDeductionInformation recordsItem) {
  ...
  **/
  ...
  public List<OnDemandPayDeductionInformation> getRecords() {
    return records;
  }


  public void setRecords(List<OnDemandPayDeductionInformation> records) {
   ...
   * @return the PagedResultOfOnDemandPayDeductionInformation instance itself
   */
  public PagedResultOfOnDemandPayDeductionInformation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfOnDemandPayDeductionInformation pagedResultOfOnDemandPayDeductionInformation = (PagedResultOfOnDemandPayDeductionInformation) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfOnDemandPayDeductionInformation.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfOnDemandPayDeductionInformation.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfOnDemandPayDeductionInformation.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfOnDemandPayDeductionInformation.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfOnDemandPayDeductionInformation.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfOnDemandPayDeductionInformation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfOnDemandPayDeductionInformation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfOnDemandPayDeductionInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfOnDemandPayDeductionInformation is not found in the empty JSON string", PagedResultOfOnDemandPayDeductionInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            OnDemandPayDeductionInformation.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfOnDemandPayDeductionInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfOnDemandPayDeductionInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfOnDemandPayDeductionInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfOnDemandPayDeductionInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfOnDemandPayDeductionInformation>() {
           @Override
           public void write(JsonWriter out, PagedResultOfOnDemandPayDeductionInformation value) throws IOException {
           ...
           @Override
           public PagedResultOfOnDemandPayDeductionInformation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfOnDemandPayDeductionInformation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfOnDemandPayDeductionInformation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfOnDemandPayDeductionInformation
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfOnDemandPayDeductionInformation
  */
  public static PagedResultOfOnDemandPayDeductionInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfOnDemandPayDeductionInformation.class);
  }

 /**
  * Convert an instance of PagedResultOfOnDemandPayDeductionInformation to an JSON string
  *
  * @return JSON string
  */
