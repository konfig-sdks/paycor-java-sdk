...
import com.konfigthis.client.model.EmployeeBalance;
...
public class PagedResultOfEmployeeBalance {
  ...
  private List<EmployeeBalance> records = null;

  public PagedResultOfEmployeeBalance() {
  }

  public PagedResultOfEmployeeBalance hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeBalance continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeBalance additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeBalance records(List<EmployeeBalance> records) {
  ...
  public PagedResultOfEmployeeBalance addRecordsItem(EmployeeBalance recordsItem) {
  ...
  **/
  ...
  public List<EmployeeBalance> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeBalance> records) {
   ...
   * @return the PagedResultOfEmployeeBalance instance itself
   */
  public PagedResultOfEmployeeBalance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeBalance pagedResultOfEmployeeBalance = (PagedResultOfEmployeeBalance) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeBalance.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeBalance.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeBalance.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeBalance.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeBalance.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeBalance {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeBalance
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeBalance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeBalance is not found in the empty JSON string", PagedResultOfEmployeeBalance.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeBalance.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeBalance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeBalance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeBalance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeBalance.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeBalance>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeBalance value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeBalance read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeBalance instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeBalance given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeBalance
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeBalance
  */
  public static PagedResultOfEmployeeBalance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeBalance.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeBalance to an JSON string
  *
  * @return JSON string
  */
