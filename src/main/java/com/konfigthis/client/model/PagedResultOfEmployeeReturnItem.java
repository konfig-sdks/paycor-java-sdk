...
import com.konfigthis.client.model.EmployeeReturnItem2;
...
public class PagedResultOfEmployeeReturnItem {
  ...
  private List<EmployeeReturnItem2> records = null;

  public PagedResultOfEmployeeReturnItem() {
  }

  public PagedResultOfEmployeeReturnItem hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeReturnItem continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeReturnItem additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeReturnItem records(List<EmployeeReturnItem2> records) {
  ...
  public PagedResultOfEmployeeReturnItem addRecordsItem(EmployeeReturnItem2 recordsItem) {
  ...
  **/
  ...
  public List<EmployeeReturnItem2> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeReturnItem2> records) {
   ...
   * @return the PagedResultOfEmployeeReturnItem instance itself
   */
  public PagedResultOfEmployeeReturnItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeReturnItem pagedResultOfEmployeeReturnItem = (PagedResultOfEmployeeReturnItem) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeReturnItem.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeReturnItem.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeReturnItem.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeReturnItem.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeReturnItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeReturnItem {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeReturnItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeReturnItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeReturnItem is not found in the empty JSON string", PagedResultOfEmployeeReturnItem.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeReturnItem2.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeReturnItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeReturnItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeReturnItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeReturnItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeReturnItem>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeReturnItem value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeReturnItem read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeReturnItem instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeReturnItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeReturnItem
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeReturnItem
  */
  public static PagedResultOfEmployeeReturnItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeReturnItem.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeReturnItem to an JSON string
  *
  * @return JSON string
  */
