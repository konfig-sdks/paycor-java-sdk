...
public class PagedResultOfTimeOffType {
  ...
  private List<TimeOffType> records = null;

  public PagedResultOfTimeOffType() {
  }

  public PagedResultOfTimeOffType hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTimeOffType continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTimeOffType additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTimeOffType records(List<TimeOffType> records) {
  ...
  public PagedResultOfTimeOffType addRecordsItem(TimeOffType recordsItem) {
  ...
  **/
  ...
  public List<TimeOffType> getRecords() {
    return records;
  }


  public void setRecords(List<TimeOffType> records) {
   ...
   * @return the PagedResultOfTimeOffType instance itself
   */
  public PagedResultOfTimeOffType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTimeOffType pagedResultOfTimeOffType = (PagedResultOfTimeOffType) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTimeOffType.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTimeOffType.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTimeOffType.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTimeOffType.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTimeOffType.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTimeOffType {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTimeOffType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTimeOffType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTimeOffType is not found in the empty JSON string", PagedResultOfTimeOffType.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TimeOffType.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTimeOffType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTimeOffType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTimeOffType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTimeOffType.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTimeOffType>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTimeOffType value) throws IOException {
           ...
           @Override
           public PagedResultOfTimeOffType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTimeOffType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTimeOffType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTimeOffType
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTimeOffType
  */
  public static PagedResultOfTimeOffType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTimeOffType.class);
  }

 /**
  * Convert an instance of PagedResultOfTimeOffType to an JSON string
  *
  * @return JSON string
  */
