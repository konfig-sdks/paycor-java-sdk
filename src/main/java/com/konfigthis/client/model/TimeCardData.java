 ...
 */
@ApiModel(description = "Employee's timecard with information about earnings, start and end dates.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TimeCardData {
  ...
  public TimeCardData earningCode(String earningCode) {
  ...
  **/
  ...
  public TimeCardData earningHours(Double earningHours) {
  ...
  public TimeCardData earningHours(Integer earningHours) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "3.5", required = true, value = "Employee's earning hours")
  ...
  public TimeCardData businessStartDate(OffsetDateTime businessStartDate) {
  ...
  **/
  ...
  public TimeCardData businessEndDate(OffsetDateTime businessEndDate) {
  ...
  **/
   ...
   * @return the TimeCardData instance itself
   */
  public TimeCardData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TimeCardData timeCardData = (TimeCardData) o;
    return Objects.equals(this.earningCode, timeCardData.earningCode) &&
        Objects.equals(this.earningHours, timeCardData.earningHours) &&
        Objects.equals(this.businessStartDate, timeCardData.businessStartDate) &&
        Objects.equals(this.businessEndDate, timeCardData.businessEndDate)&&
        Objects.equals(this.additionalProperties, timeCardData.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(earningCode, earningHours, businessStartDate, businessEndDate, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("EarningHours");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimeCardData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimeCardData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeCardData is not found in the empty JSON string", TimeCardData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimeCardData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeCardData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeCardData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeCardData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeCardData.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeCardData>() {
           @Override
           public void write(JsonWriter out, TimeCardData value) throws IOException {
           ...
           @Override
           public TimeCardData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TimeCardData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TimeCardData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimeCardData
  * @throws IOException if the JSON string is invalid with respect to TimeCardData
  */
  public static TimeCardData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeCardData.class);
  }

 /**
  * Convert an instance of TimeCardData to an JSON string
  *
  * @return JSON string
  */
