...
public class LaborCode5 {
  ...
  public LaborCode5 laborCodeId(String laborCodeId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "12e0e1c9-e8dc-ec11-912c-0050569f27b8", required = true, value = "Id of the Labor Code ")
  ...
  public LaborCode5 laborCodeName(String laborCodeName) {
  ...
  **/
  ...
  public LaborCode5 description(String description) {
  ...
  **/
  ...
  public LaborCode5 code(String code) {
  ...
  **/
  ...
  public LaborCode5 effectiveStartDate(OffsetDateTime effectiveStartDate) {
  ...
  **/
  ...
  public LaborCode5 effectiveEndDate(OffsetDateTime effectiveEndDate) {
  ...
  **/
   ...
   * @return the LaborCode5 instance itself
   */
  public LaborCode5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LaborCode5 laborCode5 = (LaborCode5) o;
    return Objects.equals(this.laborCodeId, laborCode5.laborCodeId) &&
        Objects.equals(this.laborCodeName, laborCode5.laborCodeName) &&
        Objects.equals(this.description, laborCode5.description) &&
        Objects.equals(this.code, laborCode5.code) &&
        Objects.equals(this.effectiveStartDate, laborCode5.effectiveStartDate) &&
        Objects.equals(this.effectiveEndDate, laborCode5.effectiveEndDate)&&
        Objects.equals(this.additionalProperties, laborCode5.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(laborCodeId, laborCodeName, description, code, effectiveStartDate, effectiveEndDate, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("LaborCodeId");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LaborCode5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LaborCode5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LaborCode5 is not found in the empty JSON string", LaborCode5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LaborCode5.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("LaborCodeId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LaborCode5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LaborCode5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LaborCode5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LaborCode5.class));

       return (TypeAdapter<T>) new TypeAdapter<LaborCode5>() {
           @Override
           public void write(JsonWriter out, LaborCode5 value) throws IOException {
           ...
           @Override
           public LaborCode5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LaborCode5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LaborCode5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LaborCode5
  * @throws IOException if the JSON string is invalid with respect to LaborCode5
  */
  public static LaborCode5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LaborCode5.class);
  }

 /**
  * Convert an instance of LaborCode5 to an JSON string
  *
  * @return JSON string
  */
