...
public class PagedResultOfEmployeeDirectDeposit {
  ...
  private List<EmployeeDirectDeposit> records = null;

  public PagedResultOfEmployeeDirectDeposit() {
  }

  public PagedResultOfEmployeeDirectDeposit hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeDirectDeposit continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeDirectDeposit additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeDirectDeposit records(List<EmployeeDirectDeposit> records) {
  ...
  public PagedResultOfEmployeeDirectDeposit addRecordsItem(EmployeeDirectDeposit recordsItem) {
  ...
  **/
  ...
  public List<EmployeeDirectDeposit> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeDirectDeposit> records) {
   ...
   * @return the PagedResultOfEmployeeDirectDeposit instance itself
   */
  public PagedResultOfEmployeeDirectDeposit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeDirectDeposit pagedResultOfEmployeeDirectDeposit = (PagedResultOfEmployeeDirectDeposit) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeDirectDeposit.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeDirectDeposit.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeDirectDeposit.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeDirectDeposit.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeDirectDeposit.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeDirectDeposit {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeDirectDeposit
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeDirectDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeDirectDeposit is not found in the empty JSON string", PagedResultOfEmployeeDirectDeposit.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeDirectDeposit.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeDirectDeposit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeDirectDeposit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeDirectDeposit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeDirectDeposit.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeDirectDeposit>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeDirectDeposit value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeDirectDeposit read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeDirectDeposit instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeDirectDeposit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeDirectDeposit
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeDirectDeposit
  */
  public static PagedResultOfEmployeeDirectDeposit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeDirectDeposit.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeDirectDeposit to an JSON string
  *
  * @return JSON string
  */
