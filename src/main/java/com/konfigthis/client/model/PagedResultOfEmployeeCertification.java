...
import com.konfigthis.client.model.EmployeeCertification;
...
public class PagedResultOfEmployeeCertification {
  ...
  private List<EmployeeCertification> records = null;

  public PagedResultOfEmployeeCertification() {
  }

  public PagedResultOfEmployeeCertification hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeCertification continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeCertification additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeCertification records(List<EmployeeCertification> records) {
  ...
  public PagedResultOfEmployeeCertification addRecordsItem(EmployeeCertification recordsItem) {
  ...
  **/
  ...
  public List<EmployeeCertification> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeCertification> records) {
   ...
   * @return the PagedResultOfEmployeeCertification instance itself
   */
  public PagedResultOfEmployeeCertification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeCertification pagedResultOfEmployeeCertification = (PagedResultOfEmployeeCertification) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeCertification.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeCertification.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeCertification.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeCertification.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeCertification.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeCertification {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeCertification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeCertification.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeCertification is not found in the empty JSON string", PagedResultOfEmployeeCertification.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeCertification.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeCertification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeCertification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeCertification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeCertification.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeCertification>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeCertification value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeCertification read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeCertification instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeCertification given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeCertification
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeCertification
  */
  public static PagedResultOfEmployeeCertification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeCertification.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeCertification to an JSON string
  *
  * @return JSON string
  */
