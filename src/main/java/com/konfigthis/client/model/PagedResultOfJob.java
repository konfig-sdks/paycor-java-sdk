...
public class PagedResultOfJob {
  ...
  private List<Job> records = null;

  public PagedResultOfJob() {
  }

  public PagedResultOfJob hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfJob continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfJob additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfJob records(List<Job> records) {
  ...
  public PagedResultOfJob addRecordsItem(Job recordsItem) {
  ...
  **/
   ...
   * @return the PagedResultOfJob instance itself
   */
  public PagedResultOfJob putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfJob pagedResultOfJob = (PagedResultOfJob) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfJob.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfJob.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfJob.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfJob.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfJob.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfJob {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfJob is not found in the empty JSON string", PagedResultOfJob.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            Job.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfJob.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfJob>() {
           @Override
           public void write(JsonWriter out, PagedResultOfJob value) throws IOException {
           ...
           @Override
           public PagedResultOfJob read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfJob instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfJob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfJob
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfJob
  */
  public static PagedResultOfJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfJob.class);
  }

 /**
  * Convert an instance of PagedResultOfJob to an JSON string
  *
  * @return JSON string
  */
