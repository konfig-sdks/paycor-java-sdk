...
import com.konfigthis.client.model.TenantJobTitle;
...
public class PagedResultOfTenantJobTitle {
  ...
  private List<TenantJobTitle> records = null;

  public PagedResultOfTenantJobTitle() {
  }

  public PagedResultOfTenantJobTitle hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTenantJobTitle continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTenantJobTitle additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTenantJobTitle records(List<TenantJobTitle> records) {
  ...
  public PagedResultOfTenantJobTitle addRecordsItem(TenantJobTitle recordsItem) {
  ...
  **/
  ...
  public List<TenantJobTitle> getRecords() {
    return records;
  }


  public void setRecords(List<TenantJobTitle> records) {
   ...
   * @return the PagedResultOfTenantJobTitle instance itself
   */
  public PagedResultOfTenantJobTitle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTenantJobTitle pagedResultOfTenantJobTitle = (PagedResultOfTenantJobTitle) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTenantJobTitle.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTenantJobTitle.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTenantJobTitle.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTenantJobTitle.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTenantJobTitle.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTenantJobTitle {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTenantJobTitle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTenantJobTitle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTenantJobTitle is not found in the empty JSON string", PagedResultOfTenantJobTitle.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TenantJobTitle.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTenantJobTitle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTenantJobTitle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTenantJobTitle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTenantJobTitle.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTenantJobTitle>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTenantJobTitle value) throws IOException {
           ...
           @Override
           public PagedResultOfTenantJobTitle read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTenantJobTitle instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTenantJobTitle given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTenantJobTitle
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTenantJobTitle
  */
  public static PagedResultOfTenantJobTitle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTenantJobTitle.class);
  }

 /**
  * Convert an instance of PagedResultOfTenantJobTitle to an JSON string
  *
  * @return JSON string
  */
