...
public class PagedResultOfPayPeriod {
  ...
  private List<PayPeriod> records = null;

  public PagedResultOfPayPeriod() {
  }

  public PagedResultOfPayPeriod hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod records(List<PayPeriod> records) {
  ...
  public PagedResultOfPayPeriod addRecordsItem(PayPeriod recordsItem) {
  ...
  **/
  ...
  public List<PayPeriod> getRecords() {
    return records;
  }


  public void setRecords(List<PayPeriod> records) {
   ...
   * @return the PagedResultOfPayPeriod instance itself
   */
  public PagedResultOfPayPeriod putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayPeriod pagedResultOfPayPeriod = (PagedResultOfPayPeriod) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayPeriod.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayPeriod.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayPeriod.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayPeriod.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayPeriod.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayPeriod {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayPeriod
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayPeriod.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayPeriod is not found in the empty JSON string", PagedResultOfPayPeriod.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayPeriod.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayPeriod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayPeriod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayPeriod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayPeriod.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayPeriod>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayPeriod value) throws IOException {
           ...
           @Override
           public PagedResultOfPayPeriod read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayPeriod instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayPeriod given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayPeriod
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayPeriod
  */
  public static PagedResultOfPayPeriod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayPeriod.class);
  }

 /**
  * Convert an instance of PagedResultOfPayPeriod to an JSON string
  *
  * @return JSON string
  */
