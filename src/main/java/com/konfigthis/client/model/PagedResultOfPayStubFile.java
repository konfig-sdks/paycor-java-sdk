...
import com.konfigthis.client.model.PayStubFile;
...
public class PagedResultOfPayStubFile {
  ...
  private List<PayStubFile> records = null;

  public PagedResultOfPayStubFile() {
  }

  public PagedResultOfPayStubFile hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayStubFile continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayStubFile additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayStubFile records(List<PayStubFile> records) {
  ...
  public PagedResultOfPayStubFile addRecordsItem(PayStubFile recordsItem) {
  ...
  **/
  ...
  public List<PayStubFile> getRecords() {
    return records;
  }


  public void setRecords(List<PayStubFile> records) {
   ...
   * @return the PagedResultOfPayStubFile instance itself
   */
  public PagedResultOfPayStubFile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayStubFile pagedResultOfPayStubFile = (PagedResultOfPayStubFile) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayStubFile.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayStubFile.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayStubFile.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayStubFile.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayStubFile.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayStubFile {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayStubFile
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayStubFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayStubFile is not found in the empty JSON string", PagedResultOfPayStubFile.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayStubFile.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayStubFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayStubFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayStubFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayStubFile.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayStubFile>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayStubFile value) throws IOException {
           ...
           @Override
           public PagedResultOfPayStubFile read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayStubFile instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayStubFile given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayStubFile
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayStubFile
  */
  public static PagedResultOfPayStubFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayStubFile.class);
  }

 /**
  * Convert an instance of PagedResultOfPayStubFile to an JSON string
  *
  * @return JSON string
  */
