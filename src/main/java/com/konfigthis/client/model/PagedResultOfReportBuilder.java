...
import com.konfigthis.client.model.ReportBuilder;
...
public class PagedResultOfReportBuilder {
  ...
  private List<ReportBuilder> records = null;

  public PagedResultOfReportBuilder() {
  }

  public PagedResultOfReportBuilder hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfReportBuilder continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfReportBuilder additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfReportBuilder records(List<ReportBuilder> records) {
  ...
  public PagedResultOfReportBuilder addRecordsItem(ReportBuilder recordsItem) {
  ...
  **/
  ...
  public List<ReportBuilder> getRecords() {
    return records;
  }


  public void setRecords(List<ReportBuilder> records) {
   ...
   * @return the PagedResultOfReportBuilder instance itself
   */
  public PagedResultOfReportBuilder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfReportBuilder pagedResultOfReportBuilder = (PagedResultOfReportBuilder) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfReportBuilder.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfReportBuilder.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfReportBuilder.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfReportBuilder.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfReportBuilder.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfReportBuilder {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfReportBuilder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfReportBuilder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfReportBuilder is not found in the empty JSON string", PagedResultOfReportBuilder.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            ReportBuilder.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfReportBuilder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfReportBuilder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfReportBuilder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfReportBuilder.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfReportBuilder>() {
           @Override
           public void write(JsonWriter out, PagedResultOfReportBuilder value) throws IOException {
           ...
           @Override
           public PagedResultOfReportBuilder read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfReportBuilder instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfReportBuilder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfReportBuilder
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfReportBuilder
  */
  public static PagedResultOfReportBuilder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfReportBuilder.class);
  }

 /**
  * Convert an instance of PagedResultOfReportBuilder to an JSON string
  *
  * @return JSON string
  */
