...
public class I9Verification {
  ...
  public I9Verification() {
  }

  public I9Verification citizenOfCountry(String citizenOfCountry) {
  ...
  **/
  ...
  public I9Verification workEligibility(WorkEligibility workEligibility) {
  ...
  **/
  ...
  public I9Verification workVisaType(String workVisaType) {
  ...
  **/
  ...
  public I9Verification workVisaExpirationDate(OffsetDateTime workVisaExpirationDate) {
  ...
  **/
  ...
  public I9Verification alienAdmissionNumber(String alienAdmissionNumber) {
  ...
  **/
  ...
  public I9Verification alienAdmissionExpirationDate(OffsetDateTime alienAdmissionExpirationDate) {
  ...
  **/
  ...
  public I9Verification listA(ListA listA) {
  ...
  **/
  ...
  public I9Verification listB(ListB listB) {
  ...
  **/
  ...
  public I9Verification listC(ListC listC) {
  ...
  **/
  ...
  public I9Verification foreignPassportNumber(String foreignPassportNumber) {
  ...
  **/
  ...
  public I9Verification countryOfIssuance(String countryOfIssuance) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "AU", value = "Country of issuance of the foreign passport.             ")
  ...
  public I9Verification additionalInformation(String additionalInformation) {
  ...
  **/
  ...
  public I9Verification hireDate(OffsetDateTime hireDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Hire date of the employee.")
  ...
  public I9Verification dateModified(OffsetDateTime dateModified) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Date when document were last updated.             ")
   ...
   * @return the I9Verification instance itself
   */
  public I9Verification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    I9Verification i9Verification = (I9Verification) o;
    return Objects.equals(this.citizenOfCountry, i9Verification.citizenOfCountry) &&
        Objects.equals(this.workEligibility, i9Verification.workEligibility) &&
        Objects.equals(this.workVisaType, i9Verification.workVisaType) &&
        Objects.equals(this.workVisaExpirationDate, i9Verification.workVisaExpirationDate) &&
        Objects.equals(this.alienAdmissionNumber, i9Verification.alienAdmissionNumber) &&
        Objects.equals(this.alienAdmissionExpirationDate, i9Verification.alienAdmissionExpirationDate) &&
        Objects.equals(this.listA, i9Verification.listA) &&
        Objects.equals(this.listB, i9Verification.listB) &&
        Objects.equals(this.listC, i9Verification.listC) &&
        Objects.equals(this.foreignPassportNumber, i9Verification.foreignPassportNumber) &&
        Objects.equals(this.countryOfIssuance, i9Verification.countryOfIssuance) &&
        Objects.equals(this.additionalInformation, i9Verification.additionalInformation) &&
        Objects.equals(this.hireDate, i9Verification.hireDate) &&
        Objects.equals(this.dateModified, i9Verification.dateModified)&&
        Objects.equals(this.additionalProperties, i9Verification.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(citizenOfCountry, workEligibility, workVisaType, workVisaExpirationDate, alienAdmissionNumber, alienAdmissionExpirationDate, listA, listB, listC, foreignPassportNumber, countryOfIssuance, additionalInformation, hireDate, dateModified, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class I9Verification {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to I9Verification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!I9Verification.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in I9Verification is not found in the empty JSON string", I9Verification.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!I9Verification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'I9Verification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<I9Verification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(I9Verification.class));

       return (TypeAdapter<T>) new TypeAdapter<I9Verification>() {
           @Override
           public void write(JsonWriter out, I9Verification value) throws IOException {
           ...
           @Override
           public I9Verification read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             I9Verification instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of I9Verification given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of I9Verification
  * @throws IOException if the JSON string is invalid with respect to I9Verification
  */
  public static I9Verification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, I9Verification.class);
  }

 /**
  * Convert an instance of I9Verification to an JSON string
  *
  * @return JSON string
  */
