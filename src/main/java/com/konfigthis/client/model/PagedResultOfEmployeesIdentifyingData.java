...
import com.konfigthis.client.model.EmployeesIdentifyingData;
...
public class PagedResultOfEmployeesIdentifyingData {
  ...
  private List<EmployeesIdentifyingData> records = null;

  public PagedResultOfEmployeesIdentifyingData() {
  }

  public PagedResultOfEmployeesIdentifyingData hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeesIdentifyingData continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeesIdentifyingData additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeesIdentifyingData records(List<EmployeesIdentifyingData> records) {
  ...
  public PagedResultOfEmployeesIdentifyingData addRecordsItem(EmployeesIdentifyingData recordsItem) {
  ...
  **/
  ...
  public List<EmployeesIdentifyingData> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeesIdentifyingData> records) {
   ...
   * @return the PagedResultOfEmployeesIdentifyingData instance itself
   */
  public PagedResultOfEmployeesIdentifyingData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeesIdentifyingData pagedResultOfEmployeesIdentifyingData = (PagedResultOfEmployeesIdentifyingData) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeesIdentifyingData.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeesIdentifyingData.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeesIdentifyingData.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeesIdentifyingData.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeesIdentifyingData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeesIdentifyingData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeesIdentifyingData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeesIdentifyingData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeesIdentifyingData is not found in the empty JSON string", PagedResultOfEmployeesIdentifyingData.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeesIdentifyingData.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeesIdentifyingData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeesIdentifyingData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeesIdentifyingData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeesIdentifyingData.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeesIdentifyingData>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeesIdentifyingData value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeesIdentifyingData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeesIdentifyingData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeesIdentifyingData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeesIdentifyingData
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeesIdentifyingData
  */
  public static PagedResultOfEmployeesIdentifyingData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeesIdentifyingData.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeesIdentifyingData to an JSON string
  *
  * @return JSON string
  */
