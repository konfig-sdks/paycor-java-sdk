...
import com.konfigthis.client.model.LegalEntityDeduction;
...
public class PagedResultOfLegalEntityDeduction {
  ...
  private List<LegalEntityDeduction> records = null;

  public PagedResultOfLegalEntityDeduction() {
  }

  public PagedResultOfLegalEntityDeduction hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityDeduction continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityDeduction additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityDeduction records(List<LegalEntityDeduction> records) {
  ...
  public PagedResultOfLegalEntityDeduction addRecordsItem(LegalEntityDeduction recordsItem) {
  ...
  **/
  ...
  public List<LegalEntityDeduction> getRecords() {
    return records;
  }


  public void setRecords(List<LegalEntityDeduction> records) {
   ...
   * @return the PagedResultOfLegalEntityDeduction instance itself
   */
  public PagedResultOfLegalEntityDeduction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfLegalEntityDeduction pagedResultOfLegalEntityDeduction = (PagedResultOfLegalEntityDeduction) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfLegalEntityDeduction.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfLegalEntityDeduction.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfLegalEntityDeduction.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfLegalEntityDeduction.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfLegalEntityDeduction.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfLegalEntityDeduction {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfLegalEntityDeduction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfLegalEntityDeduction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfLegalEntityDeduction is not found in the empty JSON string", PagedResultOfLegalEntityDeduction.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            LegalEntityDeduction.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfLegalEntityDeduction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfLegalEntityDeduction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfLegalEntityDeduction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfLegalEntityDeduction.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfLegalEntityDeduction>() {
           @Override
           public void write(JsonWriter out, PagedResultOfLegalEntityDeduction value) throws IOException {
           ...
           @Override
           public PagedResultOfLegalEntityDeduction read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfLegalEntityDeduction instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfLegalEntityDeduction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfLegalEntityDeduction
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfLegalEntityDeduction
  */
  public static PagedResultOfLegalEntityDeduction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfLegalEntityDeduction.class);
  }

 /**
  * Convert an instance of PagedResultOfLegalEntityDeduction to an JSON string
  *
  * @return JSON string
  */
