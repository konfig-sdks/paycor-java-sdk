...
import com.konfigthis.client.model.ScheduleGroup;
...
public class PagedResultOfScheduleGroup {
  ...
  private List<ScheduleGroup> records = null;

  public PagedResultOfScheduleGroup() {
  }

  public PagedResultOfScheduleGroup hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfScheduleGroup continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfScheduleGroup additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfScheduleGroup records(List<ScheduleGroup> records) {
  ...
  public PagedResultOfScheduleGroup addRecordsItem(ScheduleGroup recordsItem) {
  ...
  **/
  ...
  public List<ScheduleGroup> getRecords() {
    return records;
  }


  public void setRecords(List<ScheduleGroup> records) {
   ...
   * @return the PagedResultOfScheduleGroup instance itself
   */
  public PagedResultOfScheduleGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfScheduleGroup pagedResultOfScheduleGroup = (PagedResultOfScheduleGroup) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfScheduleGroup.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfScheduleGroup.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfScheduleGroup.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfScheduleGroup.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfScheduleGroup.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfScheduleGroup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfScheduleGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfScheduleGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfScheduleGroup is not found in the empty JSON string", PagedResultOfScheduleGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            ScheduleGroup.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfScheduleGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfScheduleGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfScheduleGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfScheduleGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfScheduleGroup>() {
           @Override
           public void write(JsonWriter out, PagedResultOfScheduleGroup value) throws IOException {
           ...
           @Override
           public PagedResultOfScheduleGroup read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfScheduleGroup instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfScheduleGroup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfScheduleGroup
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfScheduleGroup
  */
  public static PagedResultOfScheduleGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfScheduleGroup.class);
  }

 /**
  * Convert an instance of PagedResultOfScheduleGroup to an JSON string
  *
  * @return JSON string
  */
