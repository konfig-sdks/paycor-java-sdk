...
import com.konfigthis.client.model.TenantWorkLocation;
...
public class PagedResultOfTenantWorkLocation {
  ...
  private List<TenantWorkLocation> records = null;

  public PagedResultOfTenantWorkLocation() {
  }

  public PagedResultOfTenantWorkLocation hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTenantWorkLocation continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTenantWorkLocation additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTenantWorkLocation records(List<TenantWorkLocation> records) {
  ...
  public PagedResultOfTenantWorkLocation addRecordsItem(TenantWorkLocation recordsItem) {
  ...
  **/
  ...
  public List<TenantWorkLocation> getRecords() {
    return records;
  }


  public void setRecords(List<TenantWorkLocation> records) {
   ...
   * @return the PagedResultOfTenantWorkLocation instance itself
   */
  public PagedResultOfTenantWorkLocation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTenantWorkLocation pagedResultOfTenantWorkLocation = (PagedResultOfTenantWorkLocation) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTenantWorkLocation.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTenantWorkLocation.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTenantWorkLocation.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTenantWorkLocation.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTenantWorkLocation.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTenantWorkLocation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTenantWorkLocation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTenantWorkLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTenantWorkLocation is not found in the empty JSON string", PagedResultOfTenantWorkLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TenantWorkLocation.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTenantWorkLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTenantWorkLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTenantWorkLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTenantWorkLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTenantWorkLocation>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTenantWorkLocation value) throws IOException {
           ...
           @Override
           public PagedResultOfTenantWorkLocation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTenantWorkLocation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTenantWorkLocation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTenantWorkLocation
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTenantWorkLocation
  */
  public static PagedResultOfTenantWorkLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTenantWorkLocation.class);
  }

 /**
  * Convert an instance of PagedResultOfTenantWorkLocation to an JSON string
  *
  * @return JSON string
  */
