...
import com.konfigthis.client.model.PayGroup;
...
public class PagedResultOfPayGroup {
  ...
  private List<PayGroup> records = null;

  public PagedResultOfPayGroup() {
  }

  public PagedResultOfPayGroup hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayGroup continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayGroup additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayGroup records(List<PayGroup> records) {
  ...
  public PagedResultOfPayGroup addRecordsItem(PayGroup recordsItem) {
  ...
  **/
  ...
  public List<PayGroup> getRecords() {
    return records;
  }


  public void setRecords(List<PayGroup> records) {
   ...
   * @return the PagedResultOfPayGroup instance itself
   */
  public PagedResultOfPayGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayGroup pagedResultOfPayGroup = (PagedResultOfPayGroup) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayGroup.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayGroup.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayGroup.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayGroup.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayGroup.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayGroup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayGroup is not found in the empty JSON string", PagedResultOfPayGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayGroup.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayGroup>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayGroup value) throws IOException {
           ...
           @Override
           public PagedResultOfPayGroup read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayGroup instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayGroup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayGroup
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayGroup
  */
  public static PagedResultOfPayGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayGroup.class);
  }

 /**
  * Convert an instance of PagedResultOfPayGroup to an JSON string
  *
  * @return JSON string
  */
