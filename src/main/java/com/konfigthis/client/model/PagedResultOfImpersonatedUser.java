...
import com.konfigthis.client.model.ImpersonatedUser;
...
public class PagedResultOfImpersonatedUser {
  ...
  private List<ImpersonatedUser> records = null;

  public PagedResultOfImpersonatedUser() {
  }

  public PagedResultOfImpersonatedUser hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfImpersonatedUser continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfImpersonatedUser additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfImpersonatedUser records(List<ImpersonatedUser> records) {
  ...
  public PagedResultOfImpersonatedUser addRecordsItem(ImpersonatedUser recordsItem) {
  ...
  **/
  ...
  public List<ImpersonatedUser> getRecords() {
    return records;
  }


  public void setRecords(List<ImpersonatedUser> records) {
   ...
   * @return the PagedResultOfImpersonatedUser instance itself
   */
  public PagedResultOfImpersonatedUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfImpersonatedUser pagedResultOfImpersonatedUser = (PagedResultOfImpersonatedUser) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfImpersonatedUser.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfImpersonatedUser.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfImpersonatedUser.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfImpersonatedUser.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfImpersonatedUser.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfImpersonatedUser {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfImpersonatedUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfImpersonatedUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfImpersonatedUser is not found in the empty JSON string", PagedResultOfImpersonatedUser.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            ImpersonatedUser.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfImpersonatedUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfImpersonatedUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfImpersonatedUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfImpersonatedUser.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfImpersonatedUser>() {
           @Override
           public void write(JsonWriter out, PagedResultOfImpersonatedUser value) throws IOException {
           ...
           @Override
           public PagedResultOfImpersonatedUser read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfImpersonatedUser instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfImpersonatedUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfImpersonatedUser
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfImpersonatedUser
  */
  public static PagedResultOfImpersonatedUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfImpersonatedUser.class);
  }

 /**
  * Convert an instance of PagedResultOfImpersonatedUser to an JSON string
  *
  * @return JSON string
  */
