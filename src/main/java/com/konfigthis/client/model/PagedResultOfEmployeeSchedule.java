...
public class PagedResultOfEmployeeSchedule {
  ...
  private List<EmployeeSchedule> records = null;

  public PagedResultOfEmployeeSchedule() {
  }

  public PagedResultOfEmployeeSchedule hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeSchedule continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeSchedule additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeSchedule records(List<EmployeeSchedule> records) {
  ...
  public PagedResultOfEmployeeSchedule addRecordsItem(EmployeeSchedule recordsItem) {
  ...
  **/
  ...
  public List<EmployeeSchedule> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeSchedule> records) {
   ...
   * @return the PagedResultOfEmployeeSchedule instance itself
   */
  public PagedResultOfEmployeeSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeSchedule pagedResultOfEmployeeSchedule = (PagedResultOfEmployeeSchedule) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeSchedule.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeSchedule.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeSchedule.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeSchedule.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeSchedule.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeSchedule {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeSchedule is not found in the empty JSON string", PagedResultOfEmployeeSchedule.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeSchedule.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeSchedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeSchedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeSchedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeSchedule.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeSchedule>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeSchedule value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeSchedule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeSchedule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeSchedule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeSchedule
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeSchedule
  */
  public static PagedResultOfEmployeeSchedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeSchedule.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeSchedule to an JSON string
  *
  * @return JSON string
  */
