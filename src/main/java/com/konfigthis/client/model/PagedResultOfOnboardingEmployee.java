...
import com.konfigthis.client.model.OnboardingEmployee;
...
public class PagedResultOfOnboardingEmployee {
  ...
  private List<OnboardingEmployee> records = null;

  public PagedResultOfOnboardingEmployee() {
  }

  public PagedResultOfOnboardingEmployee hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfOnboardingEmployee continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfOnboardingEmployee additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfOnboardingEmployee records(List<OnboardingEmployee> records) {
  ...
  public PagedResultOfOnboardingEmployee addRecordsItem(OnboardingEmployee recordsItem) {
  ...
  **/
  ...
  public List<OnboardingEmployee> getRecords() {
    return records;
  }


  public void setRecords(List<OnboardingEmployee> records) {
   ...
   * @return the PagedResultOfOnboardingEmployee instance itself
   */
  public PagedResultOfOnboardingEmployee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfOnboardingEmployee pagedResultOfOnboardingEmployee = (PagedResultOfOnboardingEmployee) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfOnboardingEmployee.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfOnboardingEmployee.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfOnboardingEmployee.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfOnboardingEmployee.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfOnboardingEmployee.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfOnboardingEmployee {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfOnboardingEmployee
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfOnboardingEmployee.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfOnboardingEmployee is not found in the empty JSON string", PagedResultOfOnboardingEmployee.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            OnboardingEmployee.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfOnboardingEmployee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfOnboardingEmployee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfOnboardingEmployee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfOnboardingEmployee.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfOnboardingEmployee>() {
           @Override
           public void write(JsonWriter out, PagedResultOfOnboardingEmployee value) throws IOException {
           ...
           @Override
           public PagedResultOfOnboardingEmployee read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfOnboardingEmployee instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfOnboardingEmployee given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfOnboardingEmployee
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfOnboardingEmployee
  */
  public static PagedResultOfOnboardingEmployee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfOnboardingEmployee.class);
  }

 /**
  * Convert an instance of PagedResultOfOnboardingEmployee to an JSON string
  *
  * @return JSON string
  */
