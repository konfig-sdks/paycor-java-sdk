...
public class PagedResultOfEmployeeEarning {
  ...
  private List<EmployeeEarning> records = null;

  public PagedResultOfEmployeeEarning() {
  }

  public PagedResultOfEmployeeEarning hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeEarning continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeEarning additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeEarning records(List<EmployeeEarning> records) {
  ...
  public PagedResultOfEmployeeEarning addRecordsItem(EmployeeEarning recordsItem) {
  ...
  **/
  ...
  public List<EmployeeEarning> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeEarning> records) {
   ...
   * @return the PagedResultOfEmployeeEarning instance itself
   */
  public PagedResultOfEmployeeEarning putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeEarning pagedResultOfEmployeeEarning = (PagedResultOfEmployeeEarning) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeEarning.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeEarning.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeEarning.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeEarning.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeEarning.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeEarning {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeEarning
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeEarning.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeEarning is not found in the empty JSON string", PagedResultOfEmployeeEarning.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeEarning.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeEarning.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeEarning' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeEarning> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeEarning.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeEarning>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeEarning value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeEarning read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeEarning instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeEarning given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeEarning
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeEarning
  */
  public static PagedResultOfEmployeeEarning fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeEarning.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeEarning to an JSON string
  *
  * @return JSON string
  */
