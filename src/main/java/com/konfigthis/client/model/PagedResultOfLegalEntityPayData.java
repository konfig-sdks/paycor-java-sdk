...
import com.konfigthis.client.model.LegalEntityPayData;
...
public class PagedResultOfLegalEntityPayData {
  ...
  private List<LegalEntityPayData> records = null;

  public PagedResultOfLegalEntityPayData() {
  }

  public PagedResultOfLegalEntityPayData hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityPayData continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityPayData additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfLegalEntityPayData records(List<LegalEntityPayData> records) {
  ...
  public PagedResultOfLegalEntityPayData addRecordsItem(LegalEntityPayData recordsItem) {
  ...
  **/
  ...
  public List<LegalEntityPayData> getRecords() {
    return records;
  }


  public void setRecords(List<LegalEntityPayData> records) {
   ...
   * @return the PagedResultOfLegalEntityPayData instance itself
   */
  public PagedResultOfLegalEntityPayData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfLegalEntityPayData pagedResultOfLegalEntityPayData = (PagedResultOfLegalEntityPayData) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfLegalEntityPayData.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfLegalEntityPayData.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfLegalEntityPayData.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfLegalEntityPayData.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfLegalEntityPayData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfLegalEntityPayData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfLegalEntityPayData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfLegalEntityPayData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfLegalEntityPayData is not found in the empty JSON string", PagedResultOfLegalEntityPayData.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            LegalEntityPayData.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfLegalEntityPayData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfLegalEntityPayData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfLegalEntityPayData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfLegalEntityPayData.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfLegalEntityPayData>() {
           @Override
           public void write(JsonWriter out, PagedResultOfLegalEntityPayData value) throws IOException {
           ...
           @Override
           public PagedResultOfLegalEntityPayData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfLegalEntityPayData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfLegalEntityPayData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfLegalEntityPayData
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfLegalEntityPayData
  */
  public static PagedResultOfLegalEntityPayData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfLegalEntityPayData.class);
  }

 /**
  * Convert an instance of PagedResultOfLegalEntityPayData to an JSON string
  *
  * @return JSON string
  */
