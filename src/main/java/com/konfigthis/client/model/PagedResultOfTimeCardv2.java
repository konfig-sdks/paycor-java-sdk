...
import com.konfigthis.client.model.TimeCardv2;
...
public class PagedResultOfTimeCardv2 {
  ...
  private List<TimeCardv2> records = null;

  public PagedResultOfTimeCardv2() {
  }

  public PagedResultOfTimeCardv2 hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTimeCardv2 continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTimeCardv2 additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTimeCardv2 records(List<TimeCardv2> records) {
  ...
  public PagedResultOfTimeCardv2 addRecordsItem(TimeCardv2 recordsItem) {
  ...
  **/
  ...
  public List<TimeCardv2> getRecords() {
    return records;
  }


  public void setRecords(List<TimeCardv2> records) {
   ...
   * @return the PagedResultOfTimeCardv2 instance itself
   */
  public PagedResultOfTimeCardv2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTimeCardv2 pagedResultOfTimeCardv2 = (PagedResultOfTimeCardv2) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTimeCardv2.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTimeCardv2.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTimeCardv2.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTimeCardv2.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTimeCardv2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTimeCardv2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTimeCardv2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTimeCardv2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTimeCardv2 is not found in the empty JSON string", PagedResultOfTimeCardv2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TimeCardv2.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTimeCardv2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTimeCardv2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTimeCardv2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTimeCardv2.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTimeCardv2>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTimeCardv2 value) throws IOException {
           ...
           @Override
           public PagedResultOfTimeCardv2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTimeCardv2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTimeCardv2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTimeCardv2
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTimeCardv2
  */
  public static PagedResultOfTimeCardv2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTimeCardv2.class);
  }

 /**
  * Convert an instance of PagedResultOfTimeCardv2 to an JSON string
  *
  * @return JSON string
  */
