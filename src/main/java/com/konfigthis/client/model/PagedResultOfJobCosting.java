...
import com.konfigthis.client.model.JobCosting;
...
public class PagedResultOfJobCosting {
  ...
  private List<JobCosting> records = null;

  public PagedResultOfJobCosting() {
  }

  public PagedResultOfJobCosting hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfJobCosting continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfJobCosting additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfJobCosting records(List<JobCosting> records) {
  ...
  public PagedResultOfJobCosting addRecordsItem(JobCosting recordsItem) {
  ...
  **/
  ...
  public List<JobCosting> getRecords() {
    return records;
  }


  public void setRecords(List<JobCosting> records) {
   ...
   * @return the PagedResultOfJobCosting instance itself
   */
  public PagedResultOfJobCosting putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfJobCosting pagedResultOfJobCosting = (PagedResultOfJobCosting) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfJobCosting.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfJobCosting.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfJobCosting.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfJobCosting.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfJobCosting.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfJobCosting {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfJobCosting
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfJobCosting.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfJobCosting is not found in the empty JSON string", PagedResultOfJobCosting.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            JobCosting.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfJobCosting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfJobCosting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfJobCosting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfJobCosting.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfJobCosting>() {
           @Override
           public void write(JsonWriter out, PagedResultOfJobCosting value) throws IOException {
           ...
           @Override
           public PagedResultOfJobCosting read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfJobCosting instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfJobCosting given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfJobCosting
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfJobCosting
  */
  public static PagedResultOfJobCosting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfJobCosting.class);
  }

 /**
  * Convert an instance of PagedResultOfJobCosting to an JSON string
  *
  * @return JSON string
  */
