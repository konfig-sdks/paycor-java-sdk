...
public class PagedResultOfDepartment {
  ...
  private List<Department> records = null;

  public PagedResultOfDepartment() {
  }

  public PagedResultOfDepartment hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfDepartment continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfDepartment additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfDepartment records(List<Department> records) {
  ...
  public PagedResultOfDepartment addRecordsItem(Department recordsItem) {
  ...
  **/
   ...
   * @return the PagedResultOfDepartment instance itself
   */
  public PagedResultOfDepartment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfDepartment pagedResultOfDepartment = (PagedResultOfDepartment) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfDepartment.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfDepartment.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfDepartment.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfDepartment.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfDepartment.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfDepartment {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfDepartment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfDepartment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfDepartment is not found in the empty JSON string", PagedResultOfDepartment.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            Department.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfDepartment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfDepartment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfDepartment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfDepartment.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfDepartment>() {
           @Override
           public void write(JsonWriter out, PagedResultOfDepartment value) throws IOException {
           ...
           @Override
           public PagedResultOfDepartment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfDepartment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfDepartment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfDepartment
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfDepartment
  */
  public static PagedResultOfDepartment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfDepartment.class);
  }

 /**
  * Convert an instance of PagedResultOfDepartment to an JSON string
  *
  * @return JSON string
  */
