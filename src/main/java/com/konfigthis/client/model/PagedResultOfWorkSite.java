...
import com.konfigthis.client.model.WorkSite;
...
public class PagedResultOfWorkSite {
  ...
  private List<WorkSite> records = null;

  public PagedResultOfWorkSite() {
  }

  public PagedResultOfWorkSite hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfWorkSite continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfWorkSite additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfWorkSite records(List<WorkSite> records) {
  ...
  public PagedResultOfWorkSite addRecordsItem(WorkSite recordsItem) {
  ...
  **/
  ...
  public List<WorkSite> getRecords() {
    return records;
  }


  public void setRecords(List<WorkSite> records) {
   ...
   * @return the PagedResultOfWorkSite instance itself
   */
  public PagedResultOfWorkSite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfWorkSite pagedResultOfWorkSite = (PagedResultOfWorkSite) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfWorkSite.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfWorkSite.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfWorkSite.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfWorkSite.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfWorkSite.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfWorkSite {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfWorkSite
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfWorkSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfWorkSite is not found in the empty JSON string", PagedResultOfWorkSite.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            WorkSite.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfWorkSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfWorkSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfWorkSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfWorkSite.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfWorkSite>() {
           @Override
           public void write(JsonWriter out, PagedResultOfWorkSite value) throws IOException {
           ...
           @Override
           public PagedResultOfWorkSite read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfWorkSite instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfWorkSite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfWorkSite
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfWorkSite
  */
  public static PagedResultOfWorkSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfWorkSite.class);
  }

 /**
  * Convert an instance of PagedResultOfWorkSite to an JSON string
  *
  * @return JSON string
  */
