...
public class PagedResultOfEmployeePayStubHistory {
  ...
  private List<EmployeePayStubHistory> records = null;

  public PagedResultOfEmployeePayStubHistory() {
  }

  public PagedResultOfEmployeePayStubHistory hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayStubHistory continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayStubHistory additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeePayStubHistory records(List<EmployeePayStubHistory> records) {
  ...
  public PagedResultOfEmployeePayStubHistory addRecordsItem(EmployeePayStubHistory recordsItem) {
  ...
  **/
  ...
  public List<EmployeePayStubHistory> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeePayStubHistory> records) {
   ...
   * @return the PagedResultOfEmployeePayStubHistory instance itself
   */
  public PagedResultOfEmployeePayStubHistory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeePayStubHistory pagedResultOfEmployeePayStubHistory = (PagedResultOfEmployeePayStubHistory) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeePayStubHistory.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeePayStubHistory.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeePayStubHistory.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeePayStubHistory.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeePayStubHistory.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeePayStubHistory {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeePayStubHistory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeePayStubHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeePayStubHistory is not found in the empty JSON string", PagedResultOfEmployeePayStubHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeePayStubHistory.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeePayStubHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeePayStubHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeePayStubHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeePayStubHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeePayStubHistory>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeePayStubHistory value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeePayStubHistory read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeePayStubHistory instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeePayStubHistory given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeePayStubHistory
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeePayStubHistory
  */
  public static PagedResultOfEmployeePayStubHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeePayStubHistory.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeePayStubHistory to an JSON string
  *
  * @return JSON string
  */
