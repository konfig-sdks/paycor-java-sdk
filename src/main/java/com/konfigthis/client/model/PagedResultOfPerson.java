...
public class PagedResultOfPerson {
  ...
  private List<Person> records = null;

  public PagedResultOfPerson() {
  }

  public PagedResultOfPerson hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPerson continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPerson additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPerson records(List<Person> records) {
  ...
  public PagedResultOfPerson addRecordsItem(Person recordsItem) {
  ...
  **/
   ...
   * @return the PagedResultOfPerson instance itself
   */
  public PagedResultOfPerson putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPerson pagedResultOfPerson = (PagedResultOfPerson) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPerson.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPerson.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPerson.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPerson.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPerson.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPerson {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPerson
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPerson.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPerson is not found in the empty JSON string", PagedResultOfPerson.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            Person.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPerson.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPerson' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPerson> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPerson.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPerson>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPerson value) throws IOException {
           ...
           @Override
           public PagedResultOfPerson read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPerson instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPerson given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPerson
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPerson
  */
  public static PagedResultOfPerson fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPerson.class);
  }

 /**
  * Convert an instance of PagedResultOfPerson to an JSON string
  *
  * @return JSON string
  */
