...
import com.konfigthis.client.model.TaxFile;
...
public class PagedResultOfTaxFile {
  ...
  private List<TaxFile> records = null;

  public PagedResultOfTaxFile() {
  }

  public PagedResultOfTaxFile hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTaxFile continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTaxFile additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTaxFile records(List<TaxFile> records) {
  ...
  public PagedResultOfTaxFile addRecordsItem(TaxFile recordsItem) {
  ...
  **/
  ...
  public List<TaxFile> getRecords() {
    return records;
  }


  public void setRecords(List<TaxFile> records) {
   ...
   * @return the PagedResultOfTaxFile instance itself
   */
  public PagedResultOfTaxFile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTaxFile pagedResultOfTaxFile = (PagedResultOfTaxFile) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTaxFile.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTaxFile.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTaxFile.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTaxFile.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTaxFile.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTaxFile {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTaxFile
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTaxFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTaxFile is not found in the empty JSON string", PagedResultOfTaxFile.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TaxFile.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTaxFile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTaxFile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTaxFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTaxFile.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTaxFile>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTaxFile value) throws IOException {
           ...
           @Override
           public PagedResultOfTaxFile read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTaxFile instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTaxFile given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTaxFile
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTaxFile
  */
  public static PagedResultOfTaxFile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTaxFile.class);
  }

 /**
  * Convert an instance of PagedResultOfTaxFile to an JSON string
  *
  * @return JSON string
  */
