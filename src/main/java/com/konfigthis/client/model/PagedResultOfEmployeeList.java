...
import com.konfigthis.client.model.EmployeeList;
...
public class PagedResultOfEmployeeList {
  ...
  private List<EmployeeList> records = null;

  public PagedResultOfEmployeeList() {
  }

  public PagedResultOfEmployeeList hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfEmployeeList continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfEmployeeList additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfEmployeeList records(List<EmployeeList> records) {
  ...
  public PagedResultOfEmployeeList addRecordsItem(EmployeeList recordsItem) {
  ...
  **/
  ...
  public List<EmployeeList> getRecords() {
    return records;
  }


  public void setRecords(List<EmployeeList> records) {
   ...
   * @return the PagedResultOfEmployeeList instance itself
   */
  public PagedResultOfEmployeeList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfEmployeeList pagedResultOfEmployeeList = (PagedResultOfEmployeeList) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfEmployeeList.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfEmployeeList.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfEmployeeList.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfEmployeeList.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfEmployeeList.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfEmployeeList {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfEmployeeList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfEmployeeList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfEmployeeList is not found in the empty JSON string", PagedResultOfEmployeeList.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            EmployeeList.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfEmployeeList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfEmployeeList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfEmployeeList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfEmployeeList.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfEmployeeList>() {
           @Override
           public void write(JsonWriter out, PagedResultOfEmployeeList value) throws IOException {
           ...
           @Override
           public PagedResultOfEmployeeList read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfEmployeeList instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfEmployeeList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfEmployeeList
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfEmployeeList
  */
  public static PagedResultOfEmployeeList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfEmployeeList.class);
  }

 /**
  * Convert an instance of PagedResultOfEmployeeList to an JSON string
  *
  * @return JSON string
  */
