...
import com.konfigthis.client.model.AddressType2;
 ...
 */
@ApiModel(description = "The Person Address model represents the Person's Address information.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PersonAddress {
  ...
  private AddressType2 type;

  public PersonAddress() {
  }

  public PersonAddress streetLine1(String streetLine1) {
  ...
  **/
  ...
  public PersonAddress streetLine2(String streetLine2) {
  ...
  **/
  ...
  public PersonAddress suite(String suite) {
  ...
  **/
  ...
  public PersonAddress zipCode(String zipCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "45212-0930", value = "Zip code in the address.             ")
  ...
  public PersonAddress type(AddressType2 type) {
  ...
  **/
  ...
  public AddressType2 getType() {
    return type;
  }


  public void setType(AddressType2 type) {
   ...
   * @return the PersonAddress instance itself
   */
  public PersonAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.streetLine1, personAddress.streetLine1) &&
        Objects.equals(this.streetLine2, personAddress.streetLine2) &&
        Objects.equals(this.suite, personAddress.suite) &&
        ...
        Objects.equals(this.zipCode, personAddress.zipCode) &&
        Objects.equals(this.type, personAddress.type)&&
        Objects.equals(this.additionalProperties, personAddress.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PersonAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PersonAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonAddress is not found in the empty JSON string", PersonAddress.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PersonAddress>() {
           ...
           public PersonAddress read(JsonReader in) throws IOException {
             ...
             PersonAddress instance = thisAdapter.fromJsonTree(jsonObj);
