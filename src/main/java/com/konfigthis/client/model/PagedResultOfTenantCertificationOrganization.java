...
import com.konfigthis.client.model.TenantCertificationOrganization;
...
public class PagedResultOfTenantCertificationOrganization {
  ...
  private List<TenantCertificationOrganization> records = null;

  public PagedResultOfTenantCertificationOrganization() {
  }

  public PagedResultOfTenantCertificationOrganization hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfTenantCertificationOrganization continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfTenantCertificationOrganization additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfTenantCertificationOrganization records(List<TenantCertificationOrganization> records) {
  ...
  public PagedResultOfTenantCertificationOrganization addRecordsItem(TenantCertificationOrganization recordsItem) {
  ...
  **/
  ...
  public List<TenantCertificationOrganization> getRecords() {
    return records;
  }


  public void setRecords(List<TenantCertificationOrganization> records) {
   ...
   * @return the PagedResultOfTenantCertificationOrganization instance itself
   */
  public PagedResultOfTenantCertificationOrganization putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfTenantCertificationOrganization pagedResultOfTenantCertificationOrganization = (PagedResultOfTenantCertificationOrganization) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfTenantCertificationOrganization.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfTenantCertificationOrganization.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfTenantCertificationOrganization.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfTenantCertificationOrganization.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfTenantCertificationOrganization.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfTenantCertificationOrganization {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfTenantCertificationOrganization
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfTenantCertificationOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfTenantCertificationOrganization is not found in the empty JSON string", PagedResultOfTenantCertificationOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            TenantCertificationOrganization.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfTenantCertificationOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfTenantCertificationOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfTenantCertificationOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfTenantCertificationOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfTenantCertificationOrganization>() {
           @Override
           public void write(JsonWriter out, PagedResultOfTenantCertificationOrganization value) throws IOException {
           ...
           @Override
           public PagedResultOfTenantCertificationOrganization read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfTenantCertificationOrganization instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfTenantCertificationOrganization given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfTenantCertificationOrganization
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfTenantCertificationOrganization
  */
  public static PagedResultOfTenantCertificationOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfTenantCertificationOrganization.class);
  }

 /**
  * Convert an instance of PagedResultOfTenantCertificationOrganization to an JSON string
  *
  * @return JSON string
  */
