...
import com.konfigthis.client.model.PersonList;
...
public class PagedResultOfPersonList {
  ...
  private List<PersonList> records = null;

  public PagedResultOfPersonList() {
  }

  public PagedResultOfPersonList hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPersonList continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPersonList additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPersonList records(List<PersonList> records) {
  ...
  public PagedResultOfPersonList addRecordsItem(PersonList recordsItem) {
  ...
  **/
  ...
  public List<PersonList> getRecords() {
    return records;
  }


  public void setRecords(List<PersonList> records) {
   ...
   * @return the PagedResultOfPersonList instance itself
   */
  public PagedResultOfPersonList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPersonList pagedResultOfPersonList = (PagedResultOfPersonList) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPersonList.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPersonList.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPersonList.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPersonList.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPersonList.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPersonList {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPersonList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPersonList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPersonList is not found in the empty JSON string", PagedResultOfPersonList.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PersonList.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPersonList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPersonList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPersonList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPersonList.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPersonList>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPersonList value) throws IOException {
           ...
           @Override
           public PagedResultOfPersonList read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPersonList instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPersonList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPersonList
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPersonList
  */
  public static PagedResultOfPersonList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPersonList.class);
  }

 /**
  * Convert an instance of PagedResultOfPersonList to an JSON string
  *
  * @return JSON string
  */
