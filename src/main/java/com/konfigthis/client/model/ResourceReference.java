 ...
 */
@ApiModel(description = "The Resource Reference model is used to provide URL links to resources. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ResourceReference {
  ...
  **/
  ...
  @ApiModelProperty(example = "d63759d5-40cc-4ec2-98df-772342f1b974", value = "ID of the resource being referenced. This is generated by Paycor.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "v1/myresources/resource?resourceID=d63759d5-40cc-4ec2-98df-772342f1b974", value = "URL to reach the resource being referenced")
   ...
   * @return the ResourceReference instance itself
   */
  public ResourceReference putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceReference.id) &&
        ...
        Objects.equals(this.additionalProperties, resourceReference.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResourceReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceReference>() {
           ...
           public ResourceReference read(JsonReader in) throws IOException {
             ...
             ResourceReference instance = thisAdapter.fromJsonTree(jsonObj);
