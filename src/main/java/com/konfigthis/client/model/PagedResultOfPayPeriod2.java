...
import com.konfigthis.client.model.PayPeriod2;
...
public class PagedResultOfPayPeriod2 {
  ...
  private List<PayPeriod2> records = null;

  public PagedResultOfPayPeriod2() {
  }

  public PagedResultOfPayPeriod2 hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod2 continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod2 additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfPayPeriod2 records(List<PayPeriod2> records) {
  ...
  public PagedResultOfPayPeriod2 addRecordsItem(PayPeriod2 recordsItem) {
  ...
  **/
  ...
  public List<PayPeriod2> getRecords() {
    return records;
  }


  public void setRecords(List<PayPeriod2> records) {
   ...
   * @return the PagedResultOfPayPeriod2 instance itself
   */
  public PagedResultOfPayPeriod2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfPayPeriod2 pagedResultOfPayPeriod2 = (PagedResultOfPayPeriod2) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfPayPeriod2.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfPayPeriod2.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfPayPeriod2.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfPayPeriod2.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfPayPeriod2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfPayPeriod2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfPayPeriod2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfPayPeriod2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfPayPeriod2 is not found in the empty JSON string", PagedResultOfPayPeriod2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            PayPeriod2.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfPayPeriod2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfPayPeriod2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfPayPeriod2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfPayPeriod2.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfPayPeriod2>() {
           @Override
           public void write(JsonWriter out, PagedResultOfPayPeriod2 value) throws IOException {
           ...
           @Override
           public PagedResultOfPayPeriod2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfPayPeriod2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfPayPeriod2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfPayPeriod2
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfPayPeriod2
  */
  public static PagedResultOfPayPeriod2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfPayPeriod2.class);
  }

 /**
  * Convert an instance of PagedResultOfPayPeriod2 to an JSON string
  *
  * @return JSON string
  */
