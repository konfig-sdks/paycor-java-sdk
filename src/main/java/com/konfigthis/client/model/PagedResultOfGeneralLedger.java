...
import com.konfigthis.client.model.GeneralLedger;
...
public class PagedResultOfGeneralLedger {
  ...
  private List<GeneralLedger> records = null;

  public PagedResultOfGeneralLedger() {
  }

  public PagedResultOfGeneralLedger hasMoreResults(Boolean hasMoreResults) {
  ...
  **/
  ...
  public PagedResultOfGeneralLedger continuationToken(String continuationToken) {
  ...
  **/
  ...
  public PagedResultOfGeneralLedger additionalResultsUrl(String additionalResultsUrl) {
  ...
  **/
  ...
  public PagedResultOfGeneralLedger records(List<GeneralLedger> records) {
  ...
  public PagedResultOfGeneralLedger addRecordsItem(GeneralLedger recordsItem) {
  ...
  **/
  ...
  public List<GeneralLedger> getRecords() {
    return records;
  }


  public void setRecords(List<GeneralLedger> records) {
   ...
   * @return the PagedResultOfGeneralLedger instance itself
   */
  public PagedResultOfGeneralLedger putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PagedResultOfGeneralLedger pagedResultOfGeneralLedger = (PagedResultOfGeneralLedger) o;
    return Objects.equals(this.hasMoreResults, pagedResultOfGeneralLedger.hasMoreResults) &&
        Objects.equals(this.continuationToken, pagedResultOfGeneralLedger.continuationToken) &&
        Objects.equals(this.additionalResultsUrl, pagedResultOfGeneralLedger.additionalResultsUrl) &&
        Objects.equals(this.records, pagedResultOfGeneralLedger.records)&&
        Objects.equals(this.additionalProperties, pagedResultOfGeneralLedger.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResultOfGeneralLedger {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PagedResultOfGeneralLedger
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedResultOfGeneralLedger.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PagedResultOfGeneralLedger is not found in the empty JSON string", PagedResultOfGeneralLedger.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("Records") != null && !jsonObj.get("Records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            GeneralLedger.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PagedResultOfGeneralLedger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PagedResultOfGeneralLedger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PagedResultOfGeneralLedger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PagedResultOfGeneralLedger.class));

       return (TypeAdapter<T>) new TypeAdapter<PagedResultOfGeneralLedger>() {
           @Override
           public void write(JsonWriter out, PagedResultOfGeneralLedger value) throws IOException {
           ...
           @Override
           public PagedResultOfGeneralLedger read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PagedResultOfGeneralLedger instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PagedResultOfGeneralLedger given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PagedResultOfGeneralLedger
  * @throws IOException if the JSON string is invalid with respect to PagedResultOfGeneralLedger
  */
  public static PagedResultOfGeneralLedger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PagedResultOfGeneralLedger.class);
  }

 /**
  * Convert an instance of PagedResultOfGeneralLedger to an JSON string
  *
  * @return JSON string
  */
