...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://apis.paycor.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("Access-Token", new ApiKeyAuth("header", "Authorization"));
        authentications.put("Apim-Subscription-Key", new ApiKeyAuth("header", "Ocp-Apim-Subscription-Key"));
        ...
        if (configuration != null) {
            ...
            if (configuration.apimSubscriptionKey != null) {
                this.setApimSubscriptionKey(configuration.apimSubscriptionKey);
            }
    ...
    public String getAccessToken() {
        return ((ApiKeyAuth) this.getAuthentication("Access-Token")).getApiKey();
    }

    public void setAccessToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Access-Token")).setApiKey(apiKey);
    }

    public void setAccessTokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Access-Token")).setApiKeyPrefix(prefix);
    }
    public String getApimSubscriptionKey() {
        return ((ApiKeyAuth) this.getAuthentication("Apim-Subscription-Key")).getApiKey();
    }

    public void setApimSubscriptionKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Apim-Subscription-Key")).setApiKey(apiKey);
    }

    public void setApimSubscriptionKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Apim-Subscription-Key")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apis.paycor.com)
