...
public class GeneralLedgerApiTest {
    ...
    private static GeneralLedgerApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new GeneralLedgerApi(apiClient);
    }
    ...
    public void getByLegalEntityIdTest() throws ApiException {
        ...
        GeneralLedgerReportType reportType = null;
        List<Includes17> include = null;
        String continuationToken = null;
        PagedResultOfGeneralLedger response = api.getByLegalEntityId(legalEntityId)
                .plannerId(plannerId)
