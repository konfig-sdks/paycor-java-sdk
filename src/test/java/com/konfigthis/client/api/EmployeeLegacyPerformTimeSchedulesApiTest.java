...
/**
 * API tests for EmployeeLegacyPerformTimeSchedulesApi
 */
@Disabled
public class EmployeeLegacyPerformTimeSchedulesApiTest {

    private static EmployeeLegacyPerformTimeSchedulesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeLegacyPerformTimeSchedulesApi(apiClient);
    }
     ...
     */
    @Test
    public void addToEmployeeTest() throws ApiException {
        String employeeId = null;
        OffsetDateTime startDateTime = null;
        OffsetDateTime endDateTime = null;
        Integer beforeStartTimeInMinutes = null;
        Integer afterEndTimeInMinutes = null;
        String label = null;
        String shiftDepeartmentId = null;
        CreateOrUpdateResponse response = api.addToEmployee(employeeId)
     ...
     */
    @Test
    public void deleteLegacyScheduleTest() throws ApiException {
        String employeeId = null;
        String scheduleId = null;
        api.deleteLegacySchedule(employeeId, scheduleId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getByEmployeeIdTest() throws ApiException {
        ...
        List<EmployeeSchedule> response = api.getByEmployeeId(employeeId)
                .startDate(startDate)
                .endDate(endDate)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getByLegalEntityIdTest() throws ApiException {
        Integer legalEntityId = null;
        OffsetDateTime startDate = null;
        OffsetDateTime endDate = null;
        String continuationToken = null;
        PagedResultOfEmployeeSchedule response = api.getByLegalEntityId(legalEntityId)
                .startDate(startDate)
                .endDate(endDate)
