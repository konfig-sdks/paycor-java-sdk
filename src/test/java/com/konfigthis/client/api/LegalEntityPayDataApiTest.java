...
/**
 * API tests for LegalEntityPayDataApi
 */
@Disabled
public class LegalEntityPayDataApiTest {

    private static LegalEntityPayDataApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LegalEntityPayDataApi(apiClient);
    }
     ...
     */
    @Test
    public void getPayDatesTest() throws ApiException {
        ...
        PagedResultOfLegalEntityPayData response = api.getPayDates(legalEntityId)
