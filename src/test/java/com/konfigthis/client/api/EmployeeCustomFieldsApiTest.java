...
/**
 * API tests for EmployeeCustomFieldsApi
 */
@Disabled
public class EmployeeCustomFieldsApiTest {

    private static EmployeeCustomFieldsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeCustomFieldsApi(apiClient);
    }
    ...
    public void getByEmployeeIdTest() throws ApiException {
        ...
        List<EmployeeCustomField> response = api.getByEmployeeId(employeeId)
    ...
    public void updateByEmployeeIdTest() throws ApiException {
        String employeeId = null;
        CreateOrUpdateResponse response = api.updateByEmployeeId(employeeId)
                .execute();
        // TODO: test validations
    }
