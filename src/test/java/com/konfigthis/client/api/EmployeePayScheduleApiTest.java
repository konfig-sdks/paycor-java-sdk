...
/**
 * API tests for EmployeePayScheduleApi
 */
@Disabled
public class EmployeePayScheduleApiTest {

    private static EmployeePayScheduleApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeePayScheduleApi(apiClient);
    }
     ...
     */
    @Test
    public void getUpcomingCheckDatesTest() throws ApiException {
        String employeeId = null;
        OffsetDateTime periodStartDate = null;
        OffsetDateTime periodEndDate = null;
        String continuationToken = null;
        List<Includes8> include = null;
        PagedResultOfPayPeriod response = api.getUpcomingCheckDates(employeeId)
