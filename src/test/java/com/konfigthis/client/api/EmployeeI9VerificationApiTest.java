...
/**
 * API tests for EmployeeI9VerificationApi
 */
@Disabled
public class EmployeeI9VerificationApiTest {

    private static EmployeeI9VerificationApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeI9VerificationApi(apiClient);
    }
    ...
    public void getByEmployeeIdTest() throws ApiException {
        ...
        List<Includes7> include = null;
        I9Verification response = api.getByEmployeeId(employeeId)
                .include(include)
                .execute();
     ...
     */
    @Test
    public void updateByEmployeeIdI9VerificationTest() throws ApiException {
        String employeeId = null;
        String citizenOfCountry = null;
        WorkEligibility workEligibility = null;
        String workVisaType = null;
        OffsetDateTime workVisaExpirationDate = null;
        String alienAdmissionNumber = null;
        OffsetDateTime alienAdmissionExpirationDate = null;
        ListA listA = null;
        ListB listB = null;
        ListC listC = null;
        ...
        CreateOrUpdateResponse response = api.updateByEmployeeIdI9Verification(employeeId)
