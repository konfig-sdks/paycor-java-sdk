...
/**
 * API tests for LegalEntityPayScheduleApi
 */
@Disabled
public class LegalEntityPayScheduleApiTest {

    private static LegalEntityPayScheduleApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LegalEntityPayScheduleApi(apiClient);
    }
     ...
     */
    @Test
    public void getByLegalEntityAndPaygroupTest() throws ApiException {
        Integer legalEntityId = null;
        String payGroupId = null;
        OffsetDateTime asOfDate = null;
        OffsetDateTime untilDate = null;
        String continuationToken = null;
        PagedResultOfPayPeriod response = api.getByLegalEntityAndPaygroup(legalEntityId)
