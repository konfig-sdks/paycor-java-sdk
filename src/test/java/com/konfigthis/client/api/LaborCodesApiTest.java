...
/**
 * API tests for LaborCodesApi
 */
@Disabled
public class LaborCodesApiTest {

    private static LaborCodesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new LaborCodesApi(apiClient);
    }
     ...
     */
    @Test
    public void addLaborCodeToLegalEntityTest() throws ApiException {
        String laborCategoryId = null;
        String laborCodeName = null;
        String code = null;
        Integer legalEntityId = null;
        String description = null;
        OffsetDateTime effectiveStartDate = null;
        OffsetDateTime effectiveEndDate = null;
        CreateOrUpdateResponse response = api.addLaborCodeToLegalEntity(laborCategoryId, laborCodeName, code, legalEntityId)
    ...
    public void listByLegalEntityIdTest() throws ApiException {
        ...
        LaborCode4 response = api.listByLegalEntityId(legalEntityId)
     ...
     */
    @Test
    public void updateSpecifiedLaborCodeTest() throws ApiException {
        ...
        OffsetDateTime effectiveStartDate = null;
        OffsetDateTime effectiveEndDate = null;
        CreateOrUpdateResponse response = api.updateSpecifiedLaborCode(laborCodeId, legalEntityId)
