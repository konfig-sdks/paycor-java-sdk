...
public class TimeOffRequestsApiTest {
     ...
     */
    @Test
    public void getTimeoffRequestByIdTest() throws ApiException {
        Integer legalEntityId = null;
        String timeoffRequestId = null;
        EmployeeTimeOffRequest response = api.getTimeoffRequestById(legalEntityId, timeoffRequestId)
                .execute();
    ...
    public void listByEmployeeIdTest() throws ApiException {
        ...
        PagedResultOfEmployeeTimeOffRequest response = api.listByEmployeeId(employeeId, startDate, endDate)
    ...
    public void listByLegalEntityIdTest() throws ApiException {
        ...
        OffsetDateTime endDate = null;
        String continuationToken = null;
        PagedResultOfEmployeeTimeOffRequest response = api.listByLegalEntityId(legalEntityId, startDate, endDate)
                .continuationToken(continuationToken)
                .execute();
        // TODO: test validations
    }
