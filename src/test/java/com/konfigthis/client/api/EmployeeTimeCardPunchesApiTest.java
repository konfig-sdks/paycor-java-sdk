...
/**
 * API tests for EmployeeTimeCardPunchesApi
 */
@Disabled
public class EmployeeTimeCardPunchesApiTest {

    private static EmployeeTimeCardPunchesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeTimeCardPunchesApi(apiClient);
    }
    ...
    public void getByEmployeeIdTest() throws ApiException {
        ...
        PagedResultOfTimeCardV3 response = api.getByEmployeeId(employeeId)
                .startDate(startDate)
                .endDate(endDate)
    ...
    public void getByLegalEntityIdTest() throws ApiException {
        ...
        OffsetDateTime endDate = null;
        String continuationToken = null;
        PagedResultOfTimeCardV3 response = api.getByLegalEntityId(legalEntityId)
                .startDate(startDate)
                .endDate(endDate)
                .continuationToken(continuationToken)
                .execute();
