...
public class PersonsApiTest {
    ...
    private static PersonsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new PersonsApi(apiClient);
    }
     ...
     */
    @Test
    public void getByEmployeeIdPersonTest() throws ApiException {
        String employeeId = null;
        List<Includes21> include = null;
        Person response = api.getByEmployeeIdPerson(employeeId)
                .include(include)
                .execute();
     ...
     */
    @Test
    public void getByTenantAndPersonTest() throws ApiException {
        Integer tenantId = null;
        String personId = null;
        List<Includes20> include = null;
        Person response = api.getByTenantAndPerson(tenantId, personId)
                .include(include)
                .execute();
        // TODO: test validations
    }
    ...
    public void listByLegalEntityIdTest() throws ApiException {
        ...
        List<IncludesList> include = null;
        String continuationToken = null;
        PagedResultOfPerson response = api.listByLegalEntityId(legalEntityId)
                .include(include)
    ...
    public void listByTenantIdTest() throws ApiException {
        Integer tenantId = null;
        String continuationToken = null;
        PagedResultOfPersonList response = api.listByTenantId(tenantId)
                .continuationToken(continuationToken)
                .execute();
        // TODO: test validations
    }
