...
/**
 * API tests for EmployeeEmergencyContactApi
 */
@Disabled
public class EmployeeEmergencyContactApiTest {

    private static EmployeeEmergencyContactApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeeEmergencyContactApi(apiClient);
    }
     ...
     */
    @Test
    public void createUpdateTest() throws ApiException {
        ...
        CreateOrUpdateResponse response = api.createUpdate(firstName, lastName, employeeId)
