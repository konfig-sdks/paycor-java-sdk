...
/**
 * API tests for EmployeePayStubsApi
 */
@Disabled
public class EmployeePayStubsApiTest {

    private static EmployeePayStubsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new EmployeePayStubsApi(apiClient);
    }
    ...
    public void getByEmployeeIdTest() throws ApiException {
        ...
        OffsetDateTime checkDate = null;
        OffsetDateTime processDate = null;
        String plannerId = null;
        List<Includes9> include = null;
        String continuationToken = null;
        PagedResultOfPayStub response = api.getByEmployeeId(employeeId)
                .checkDate(checkDate)
     ...
     */
    @Test
    public void getByLegalEntityTest() throws ApiException {
        Integer legalEntityId = null;
        OffsetDateTime checkDate = null;
        OffsetDateTime processDate = null;
        String plannerId = null;
        List<Includes10> include = null;
        String continuationToken = null;
        PagedResultOfPayStub2 response = api.getByLegalEntity(legalEntityId)
                .checkDate(checkDate)
                .processDate(processDate)
                .plannerId(plannerId)
                .include(include)
     ...
     */
    @Test
    public void getYtdByEmployeeIdTest() throws ApiException {
        String employeeId = null;
        OffsetDateTime toCheckDate = null;
        List<Includes11> include = null;
        EmployeePayStubHistory response = api.getYtdByEmployeeId(employeeId, toCheckDate)
                .include(include)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getYtdByLegalEntityTest() throws ApiException {
        Integer legalEntityId = null;
        OffsetDateTime toCheckDate = null;
        List<Includes12> include = null;
        PagedResultOfEmployeePayStubHistory response = api.getYtdByLegalEntity(legalEntityId, toCheckDate)
                .include(include)
                .execute();
        // TODO: test validations
    }
